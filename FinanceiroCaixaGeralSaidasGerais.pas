unit FinanceiroCaixaGeralSaidasGerais;
...
type
  TBoxFinanceiroCaixaGeralSaidasGerais = class(TForm)
...
var
  Retorno : String;
  BoxFinanceiroCaixaGeralSaidasGerais: TBoxFinanceiroCaixaGeralSaidasGerais;
...
procedure TBoxFinanceiroCaixaGeralSaidasGerais.BtnConfirmaClick(Sender: TObject);
begin
...
procedure TBoxFinanceiroCaixaGeralSaidasGerais.GravaDados;
var
   mDocumento : String;
   mData : TDateTime;
   mConta : String;
...
procedure TBoxFinanceiroCaixaGeralSaidasGerais.CodigoContaExit(Sender: TObject);
begin
...
procedure TBoxFinanceiroCaixaGeralSaidasGerais.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Fdb1.IBTransaction.RollbackRetaining;
  FecharDs;
  Action :=caFree;
  BoxFinanceiroCaixaGeralSaidasGerais := nil;
end;

procedure TBoxFinanceiroCaixaGeralSaidasGerais.FormKeyPress(Sender: TObject;
  var Key: Char);
begin
  if Key = #27 then
   begin
...
procedure TBoxFinanceiroCaixaGeralSaidasGerais.FormShow(Sender: TObject);
begin
  AbrirDs;
  Inicio;
end;

procedure TBoxFinanceiroCaixaGeralSaidasGerais.Inicio;
begin
  Dinheiro.Value := 0;
  Cheque.Value := 0;
  NomeConta.Text := '';
...
procedure TBoxFinanceiroCaixaGeralSaidasGerais.SpeedButton1Click(Sender: TObject);
begin
...
procedure TBoxFinanceiroCaixaGeralSaidasGerais.tblCaixaAfterCancel(
  DataSet: TDataSet);
begin
  Fdb1.IBTransaction.RollbackRetaining;
end;

procedure TBoxFinanceiroCaixaGeralSaidasGerais.tblCaixaAfterPost(
  DataSet: TDataSet);
begin
   Fdb1.IBTransaction.CommitRetaining;
end;

procedure TBoxFinanceiroCaixaGeralSaidasGerais.FecharDs;
begin
...
procedure TBoxFinanceiroCaixaGeralSaidasGerais.AbrirDs;
begin

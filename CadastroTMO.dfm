object BoxTMO: TBoxTMO
  Left = 5
  Top = 85
  Caption = 'Cadastro de TMO'
  ClientHeight = 250
  ClientWidth = 596
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object JvDBMaskEditDescricao: TJvDBMaskEdit
      ...
      DataField = 'DESCRICAO'
      DataSource = DataSourceTMO
      MaxLength = 35
      TabOrder = 2
      EditMask = 'ccccccccccccccccccccccccccccccccccc;1;_'
      OnKeyPress = FormKeyPress
    end
    ...
    object JvDBMaskEditTempoGarantia: TJvDBMaskEdit
      Left = 98
      Top = 144
      Width = 48
      Height = 21
    ...
    object Categoria1: TDBLookupComboBox
      Left = 98
      Top = 90
      Width = 145
      Height = 21
      ...
      ListField = 'DESCRICAO'
      ListSource = DataSourceCategoria
      TabOrder = 3
      OnKeyPress = FormKeyPress
    end
    object Revisao: TComboBox
      Left = 98
      Top = 171
      Width = 175
      Height = 21
      ...
      OnExit = RevisaoExit
      Items.Strings = (
        'Sim - custeada pela f'#225'brica'
        'N'#227'o - custeada pelo cliente')
    end
  end
  ...
  object tbltMO: TIBDataSet
    ...
    AfterCancel = tbltMOAfterCancel
    AfterDelete = tbltMOAfterPost
    AfterPost = tbltMOAfterPost
    BufferChunks = 1000
    CachedUpdates = False
    DeleteSQL.Strings = (
      'delete from TMO'

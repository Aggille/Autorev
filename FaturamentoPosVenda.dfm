object BoxFaturamentoPosVenda: TBoxFaturamentoPosVenda
  Left = 15
  Top = 150
  Caption = 'Faturamento p'#243's-venda'
  ClientHeight = 432
  ClientWidth = 973
  Color = clBtnFace
  ...
  object tblAtendimentoRecebimento: TIBDataSet
    ...
    object tblAtendimentoRecebimentoFORMA_PAGAMENTO: TStringField
      FieldKind = fkLookup
      FieldName = 'FORMA_PAGAMENTO'
  ...
  object IBQuery1: TIBQuery
    ...
    Transaction = FDB1.IBTransaction
    AfterCancel = tblAtendimentoAfterCancel
    AfterClose = tblAtendimentoAfterPost
    AfterDelete = tblAtendimentoAfterPost
    AfterPost = tblAtendimentoAfterPost
    BufferChunks = 1000
    CachedUpdates = False
  ...
  object tblAtendimentoPecas: TIBDataSet
    ...
    SelectSQL.Strings = (
      'select ATENDIMENTO_PECAS.*, PECAS.CODIGO,'
      'PECAS.DESCRICAO'
      'from ATENDIMENTO_PECAS'
      'inner join pecas on (Atendimento_pecas.id_pecas ='
      'pecas.id_pecas)'
      'where id_Atendimento = :idAtendimento')
    ModifySQL.Strings = (
  ...
  object tblAtendimento: TIBDataSet
    ...
    AfterDelete = tblAtendimentoAfterPost
    AfterPost = tblAtendimentoAfterPost
    BeforeDelete = tblAtendimentoBeforeDelete
    BufferChunks = 1000
    CachedUpdates = False
    DeleteSQL.Strings = (
    ...
    SelectSQL.Strings = (
      ...
      'where '
      'id_Atendimento = :idAtendimento and'
      'Status <> '#39'Fechado'#39' and'
      'Status <> '#39'Em edi'#231#227'o'#39' and'
      'Status <> '#39'Cancelado'#39' and'
      'Orc_OS = 2'
      'and'
  ...
  object DataSourceSerieNFS: TDataSource
    AutoEdit = False
    DataSet = tblSerieNFS
    Left = 568
    Top = 152
  end
  object tblAuxFaturas: TClientDataSet
    ...
    Left = 408
    Top = 264
    object tblAuxFaturasID_NOFISA: TIntegerField
      FieldName = 'ID_NOFISA'
    end
    object tblAuxFaturasFATURA: TStringField
      FieldName = 'FATURA'
    end
    object tblAuxFaturasVENCIMENTO: TDateTimeField
      FieldName = 'VENCIMENTO'
    end
    object tblAuxFaturasVALOR: TCurrencyField
      FieldName = 'VALOR'
    end
    object tblAuxFaturasID_FORMAS_PAGAMENTO: TIntegerField
      FieldName = 'ID_FORMAS_PAGAMENTO'
    end
    object tblAuxFaturasFORMA_PAGAMENTO: TStringField
      FieldName = 'FORMA_PAGAMENTO'
    end
    object tblAuxFaturasNUMERO_CV: TStringField
      FieldName = 'NUMERO_CV'
    end
  end
  object dts1: TDataSource
    AutoEdit = False
    DataSet = tblAuxFaturas
    Left = 464
    Top = 264
  end
  object tblNofisa1: TIBDataSet
    ...
    Left = 536
    Top = 288
    object tblNofisa1ID_NOFISA: TIntegerField
      FieldName = 'ID_NOFISA'
      Origin = '"NOFISA"."ID_NOFISA"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object tblNofisa1ID_CONCESSIONARIA: TIntegerField
      FieldName = 'ID_CONCESSIONARIA'
      Origin = '"NOFISA"."ID_CONCESSIONARIA"'
      Required = True
    end
    object tblNofisa1ID_CLIENTES: TIntegerField
      FieldName = 'ID_CLIENTES'
      Origin = '"NOFISA"."ID_CLIENTES"'
      Required = True
    end
    object tblNofisa1NUMERO: TIntegerField
      FieldName = 'NUMERO'
      Origin = '"NOFISA"."NUMERO"'
    end
    object tblNofisa1SERIENF: TIBStringField
      FieldName = 'SERIENF'
      Origin = '"NOFISA"."SERIENF"'
      Size = 2
    end
    object tblNofisa1EMISSAO: TDateField
      FieldName = 'EMISSAO'
      Origin = '"NOFISA"."EMISSAO"'
    end
    object tblNofisa1ORIGEM: TIBStringField
      FieldName = 'ORIGEM'
      Origin = '"NOFISA"."ORIGEM"'
      FixedChar = True
      Size = 1
    end
    object tblNofisa1ENT_SAI: TIBStringField
      FieldName = 'ENT_SAI'
      Origin = '"NOFISA"."ENT_SAI"'
      FixedChar = True
      Size = 1
    end
    object tblNofisa1VENDEDOR: TIntegerField
      FieldName = 'VENDEDOR'
      Origin = '"NOFISA"."VENDEDOR"'
    end
    object tblNofisa1SAIDA: TDateField
      FieldName = 'SAIDA'
      Origin = '"NOFISA"."SAIDA"'
    end
    object tblNofisa1HORA: TIBStringField
      FieldName = 'HORA'
      Origin = '"NOFISA"."HORA"'
      FixedChar = True
      Size = 5
    end
    object tblNofisa1IE_SUBS: TIBStringField
      FieldName = 'IE_SUBS'
      Origin = '"NOFISA"."IE_SUBS"'
      FixedChar = True
      Size = 15
    end
    object tblNofisa1DESC_PEC: TIBBCDField
      FieldName = 'DESC_PEC'
      Origin = '"NOFISA"."DESC_PEC"'
      Precision = 18
      Size = 2
    end
    object tblNofisa1DESC_OFI: TIBBCDField
      FieldName = 'DESC_OFI'
      Origin = '"NOFISA"."DESC_OFI"'
      Precision = 18
      Size = 2
    end
    object tblNofisa1BASE_ICMS: TIBBCDField
      FieldName = 'BASE_ICMS'
      Origin = '"NOFISA"."BASE_ICMS"'
      Precision = 18
      Size = 2
    end
    object tblNofisa1VAL_ICMS: TIBBCDField
      FieldName = 'VAL_ICMS'
      Origin = '"NOFISA"."VAL_ICMS"'
      Precision = 18
      Size = 2
    end
    object tblNofisa1BASE_ICM_S: TIBBCDField
      FieldName = 'BASE_ICM_S'
      Origin = '"NOFISA"."BASE_ICM_S"'
      Precision = 18
      Size = 2
    end
    object tblNofisa1VAL_ICMS_S: TIBBCDField
      FieldName = 'VAL_ICMS_S'
      Origin = '"NOFISA"."VAL_ICMS_S"'
      Precision = 18
      Size = 2
    end
    object tblNofisa1VAL_FRETE: TIBBCDField
      FieldName = 'VAL_FRETE'
      Origin = '"NOFISA"."VAL_FRETE"'
      Precision = 18
      Size = 2
    end
    object tblNofisa1VAL_SEGURO: TIBBCDField
      FieldName = 'VAL_SEGURO'
      Origin = '"NOFISA"."VAL_SEGURO"'
      Precision = 18
      Size = 2
    end
    object tblNofisa1VAL_OUTROS: TIBBCDField
      FieldName = 'VAL_OUTROS'
      Origin = '"NOFISA"."VAL_OUTROS"'
      Precision = 18
      Size = 2
    end
    object tblNofisa1VAL_IPI: TIBBCDField
      FieldName = 'VAL_IPI'
      Origin = '"NOFISA"."VAL_IPI"'
      Precision = 18
      Size = 2
    end
    object tblNofisa1VAL_SERV: TIBBCDField
      FieldName = 'VAL_SERV'
      Origin = '"NOFISA"."VAL_SERV"'
      Precision = 18
      Size = 2
    end
    object tblNofisa1ISSQN: TIBBCDField
      FieldName = 'ISSQN'
      Origin = '"NOFISA"."ISSQN"'
      Precision = 9
      Size = 2
    end
    object tblNofisa1VAL_ISS: TIBBCDField
      FieldName = 'VAL_ISS'
      Origin = '"NOFISA"."VAL_ISS"'
      Precision = 18
      Size = 2
    end
    object tblNofisa1TOT_PROD: TIBBCDField
      FieldName = 'TOT_PROD'
      Origin = '"NOFISA"."TOT_PROD"'
      Precision = 18
      Size = 2
    end
    object tblNofisa1TOT_NOTA: TIBBCDField
      FieldName = 'TOT_NOTA'
      Origin = '"NOFISA"."TOT_NOTA"'
      Precision = 18
      Size = 2
    end
    object tblNofisa1PIS: TIBBCDField
      FieldName = 'PIS'
      Origin = '"NOFISA"."PIS"'
      Precision = 18
      Size = 2
    end
    object tblNofisa1COFINS: TIBBCDField
      FieldName = 'COFINS'
      Origin = '"NOFISA"."COFINS"'
      Precision = 18
      Size = 2
    end
    object tblNofisa1COD_TRANS: TIBStringField
      FieldName = 'COD_TRANS'
      Origin = '"NOFISA"."COD_TRANS"'
      FixedChar = True
      Size = 5
    end
    object tblNofisa1FRETE_TIPO: TIBStringField
      FieldName = 'FRETE_TIPO'
      Origin = '"NOFISA"."FRETE_TIPO"'
      FixedChar = True
      Size = 1
    end
    object tblNofisa1PLACA: TIBStringField
      FieldName = 'PLACA'
      Origin = '"NOFISA"."PLACA"'
      FixedChar = True
      Size = 7
    end
    object tblNofisa1QTDE_PROD: TIntegerField
      FieldName = 'QTDE_PROD'
      Origin = '"NOFISA"."QTDE_PROD"'
    end
    object tblNofisa1STATUS: TIBStringField
      FieldName = 'STATUS'
      Origin = '"NOFISA"."STATUS"'
    end
    object tblNofisa1CODIGO_FISCAL: TIBStringField
      FieldName = 'CODIGO_FISCAL'
      Origin = '"NOFISA"."CODIGO_FISCAL"'
      Size = 19
    end
    object tblNofisa1DESCRICAO_CODIGO_FISCAL: TIBStringField
      FieldName = 'DESCRICAO_CODIGO_FISCAL'
      Origin = '"NOFISA"."DESCRICAO_CODIGO_FISCAL"'
      Size = 60
    end
    object tblNofisa1FORMA_PAGAMENTO: TIBStringField
      FieldName = 'FORMA_PAGAMENTO'
      Origin = '"NOFISA"."FORMA_PAGAMENTO"'
      Size = 1
    end
    object tblNofisa1CHAVE: TIBStringField
      FieldName = 'CHAVE'
      Origin = '"NOFISA"."CHAVE"'
      Size = 60
    end
    object tblNofisa1RECIBO: TIBStringField
      FieldName = 'RECIBO'
      Origin = '"NOFISA"."RECIBO"'
      Size = 60
    end
    object tblNofisa1PROTOCOLO: TIBStringField
      FieldName = 'PROTOCOLO'
      Origin = '"NOFISA"."PROTOCOLO"'
      Size = 60
    end
    object tblNofisa1ARQUIVO: TIBStringField
      FieldName = 'ARQUIVO'
      Origin = '"NOFISA"."ARQUIVO"'
      Size = 60
    end
    object tblNofisa1XML: TBlobField
      FieldName = 'XML'
      Origin = '"NOFISA"."XML"'
      ProviderFlags = [pfInUpdate]
      Size = 8
    end
    object tblNofisa1PROTOCOLO_CANCELAMENTO: TIBStringField
      FieldName = 'PROTOCOLO_CANCELAMENTO'
      Origin = '"NOFISA"."PROTOCOLO_CANCELAMENTO"'
      Size = 60
    end
    object tblNofisa1MOTIVO_CANCELAMENTO: TIBStringField
      FieldName = 'MOTIVO_CANCELAMENTO'
      Origin = '"NOFISA"."MOTIVO_CANCELAMENTO"'
      Size = 60
    end
    object tblNofisa1RECEBIMENTO_TRANSFERENCIA: TDateField
      FieldName = 'RECEBIMENTO_TRANSFERENCIA'
      Origin = '"NOFISA"."RECEBIMENTO_TRANSFERENCIA"'
    end
    object tblNofisa1TRANSFERENCIA_PENDENTE: TIBStringField
      FieldName = 'TRANSFERENCIA_PENDENTE'
      Origin = '"NOFISA"."TRANSFERENCIA_PENDENTE"'
      FixedChar = True
      Size = 1
    end
    object tblNofisa1ID_MECANICO: TIntegerField
      FieldName = 'ID_MECANICO'
      Origin = '"NOFISA"."ID_MECANICO"'
    end
    object tblNofisa1ID_ATENDENTE: TIntegerField
      FieldName = 'ID_ATENDENTE'
      Origin = '"NOFISA"."ID_ATENDENTE"'
    end
    object tblNofisa1QUANTIDADE_VOLUMES: TIntegerField
      FieldName = 'QUANTIDADE_VOLUMES'
      Origin = '"NOFISA"."QUANTIDADE_VOLUMES"'
    end
    object tblNofisa1NFE_REFERENCIADA: TIBStringField
      FieldName = 'NFE_REFERENCIADA'
      Origin = '"NOFISA"."NFE_REFERENCIADA"'
      Size = 60
    end
    object tblNofisa1NUMERO_NFSE: TIBStringField
      FieldName = 'NUMERO_NFSE'
      Origin = '"NOFISA"."NUMERO_NFSE"'
    end
    object tblNofisa1CODIGO_NFSE: TIBStringField
      FieldName = 'CODIGO_NFSE'
      Origin = '"NOFISA"."CODIGO_NFSE"'
      Size = 10
    end
    object tblNofisa1ARQ_XML_RPS: TIBStringField
      FieldName = 'ARQ_XML_RPS'
      Origin = '"NOFISA"."ARQ_XML_RPS"'
      Size = 100
    end
    object tblNofisa1ARQ_XML_NFSE: TIBStringField
      FieldName = 'ARQ_XML_NFSE'
      Origin = '"NOFISA"."ARQ_XML_NFSE"'
      Size = 100
    end
    object tblNofisa1XML_NFSE: TMemoField
      FieldName = 'XML_NFSE'
      Origin = '"NOFISA"."XML_NFSE"'
      ProviderFlags = [pfInUpdate]
      BlobType = ftMemo
    ...
    object tblNofisa1XML_RPS: TMemoField
      FieldName = 'XML_RPS'
      Origin = '"NOFISA"."XML_RPS"'
      ProviderFlags = [pfInUpdate]
      BlobType = ftMemo
    ...
    object tblNofisa1OBS: TIBStringField
      FieldName = 'OBS'
      Origin = '"NOFISA"."OBS"'
      FixedChar = True
      Size = 60
    end
    object tblNofisa1DADOS_AD01: TIBStringField
      FieldName = 'DADOS_AD01'
      Origin = '"NOFISA"."DADOS_AD01"'
      FixedChar = True
      Size = 51
    end
    object tblNofisa1DADOS_AD02: TIBStringField
      FieldName = 'DADOS_AD02'
      Origin = '"NOFISA"."DADOS_AD02"'
      FixedChar = True
      Size = 51
    end
    object tblNofisa1DADOS_AD03: TIBStringField
      FieldName = 'DADOS_AD03'
      Origin = '"NOFISA"."DADOS_AD03"'
      FixedChar = True
      Size = 51
    end
    object tblNofisa1DADOS_AD04: TIBStringField
      FieldName = 'DADOS_AD04'
      Origin = '"NOFISA"."DADOS_AD04"'
      FixedChar = True
      Size = 51
    end
    object tblNofisa1DADOS_AD05: TIBStringField
      FieldName = 'DADOS_AD05'
      Origin = '"NOFISA"."DADOS_AD05"'
      Size = 50
    end

object BoxCFOP: TBoxCFOP
  ...
  object tblCfop: TIBDataSet
    ...
    AfterCancel = tblCfopAfterCancel
    AfterDelete = tblCfopAfterPost
    AfterPost = tblCfopAfterPost
    DeleteSQL.Strings = (
      'delete from CFOP'
      'where'
      '  ID_CFOP = :OLD_ID_CFOP')
  ...
  object SQLDataSet1: TSQLDataSet
    SchemaName = 'sysdba'
    CommandText = 'select * from CFOP'#13#10'where id_cfop = :id'
  ...
  object ClientDataSet1: TClientDataSet
    ...
    Left = 248
    Top = 40
    object ClientDataSet1ID_CFOP: TIntegerField
      FieldName = 'ID_CFOP'
      Required = True
    end

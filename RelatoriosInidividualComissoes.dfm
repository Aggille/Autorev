  ...
  object tblComissoes: TIBDataSet
    ...
    InsertSQL.Strings = (
      'insert into comissoes'
        ...
        '  (ID_COMISSOES, CHASSI, MODELO, ID_CLIENTES, ID_VEICULOS, ID_PE' +
        'DIDO_VEICULOS, '
      
        '   ID_VENDEDOR, MARCA, ANO_MODELO, ANO_FABRICACAO, ORIGEM, BASE_' +
        'COMISSAO, '
      
        '   PERCENTUAL, VALOR_VIP, VALOR_NORMAL, VALOR_EXCLUSIVO, DATA_PE' +
        'DIDO)'
      'values'
      
        '  (:ID_COMISSOES, :CHASSI, :MODELO, :ID_CLIENTES, :ID_VEICULOS, ' +
        ':ID_PEDIDO_VEICULOS, '
      
        '   :ID_VENDEDOR, :MARCA, :ANO_MODELO, :ANO_FABRICACAO, :ORIGEM, ' +
        ':BASE_COMISSAO, '
      
        '   :PERCENTUAL, :VALOR_VIP, :VALOR_NORMAL, :VALOR_EXCLUSIVO, :DA' +
        'TA_PEDIDO)')
    RefreshSQL.Strings = (
      'Select '
      'from comissoes '
    ...
    SelectSQL.Strings = (
      'select Comissoes.*, Clientes.Nome from Comissoes'
      
        'inner join Clientes on (Clientes.Id_Clientes = Comissoes.Id_Clie' +
        'ntes)'

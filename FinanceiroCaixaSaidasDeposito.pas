unit FinanceiroCaixaSaidasDeposito;
...
type
  TBoxFinanceiroCaixaSaidasDeposito = class(TForm)
...
var
  Retorno : String;
  BoxFinanceiroCaixaSaidasDeposito: TBoxFinanceiroCaixaSaidasDeposito;
...
procedure TBoxFinanceiroCaixaSaidasDeposito.BitBtn1Click(Sender: TObject);
begin
...
procedure TBoxFinanceiroCaixaSaidasDeposito.BtnConfirmaClick(Sender: TObject);
begin
...
procedure TBoxFinanceiroCaixaSaidasDeposito.GravaDados;
var
   mDocumento : String;
   mData : TDateTime;
   mConta : String;
...
procedure TBoxFinanceiroCaixaSaidasDeposito.CodigoContaExit(Sender: TObject);
begin
...
procedure TBoxFinanceiroCaixaSaidasDeposito.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  FecharDs;
  Action :=caFree;
  BoxFinanceiroCaixaSaidasDeposito := nil;
end;

procedure TBoxFinanceiroCaixaSaidasDeposito.FormKeyPress(Sender: TObject;
  var Key: Char);
begin
  if Key = #27 then
   begin
...
procedure TBoxFinanceiroCaixaSaidasDeposito.FormShow(Sender: TObject);
begin
//  AbrirDs;
  Inicio;
end;

procedure TBoxFinanceiroCaixaSaidasDeposito.Inicio;
begin
  FecharDs;
  AbrirDs;
  Dinheiro.Value := 0;
...
procedure TBoxFinanceiroCaixaSaidasDeposito.JvContaValidate(
  Sender: TObject; ValueToValidate: Variant; var Valid: Boolean);
begin
    valid := ( tblCaixa.fieldbyname( 'Conta' ).asString <> '' )
end;

procedure TBoxFinanceiroCaixaSaidasDeposito.JvChequeValidate(
  Sender: TObject; ValueToValidate: Variant; var Valid: Boolean);
begin
    valid := ( Cheque.value <> 0 )
end;

procedure TBoxFinanceiroCaixaSaidasDeposito.JvDataValidate(Sender: TObject;
  ValueToValidate: Variant; var Valid: Boolean);
begin
    valid := ( tblCaixa.fieldbyname( 'Data_Recebimento' ).asString <> '' )
end;

procedure TBoxFinanceiroCaixaSaidasDeposito.jvDocumentoValidate(Sender: TObject;
  ValueToValidate: Variant; var Valid: Boolean);
begin
    valid := ( tblCaixa.fieldbyname( 'documento' ).asString <> '' )
end;

procedure TBoxFinanceiroCaixaSaidasDeposito.JvHistoricoValidate(Sender: TObject;
  ValueToValidate: Variant; var Valid: Boolean);
begin
    valid := ( tblCaixa.fieldbyname( 'Historico' ).asString <> '' )
end;

procedure TBoxFinanceiroCaixaSaidasDeposito.JvValorDinheiroValidate(
  Sender: TObject; ValueToValidate: Variant; var Valid: Boolean);
begin
    valid := ( dinheiro.value <> 0 )
end;

procedure TBoxFinanceiroCaixaSaidasDeposito.SpeedButton1Click(Sender: TObject);
begin
...
procedure TBoxFinanceiroCaixaSaidasDeposito.tblBancoBeforePost(
  DataSet: TDataSet);
var
mensagem:String;
x:Integer;
...
procedure TBoxFinanceiroCaixaSaidasDeposito.tblCaixaAfterCancel(
  DataSet: TDataSet);
begin
  Fdb1.IBTransaction.RollbackRetaining;
end;

procedure TBoxFinanceiroCaixaSaidasDeposito.tblCaixaAfterPost(
  DataSet: TDataSet);
begin
   Fdb1.IBTransaction.CommitRetaining;
end;

procedure TBoxFinanceiroCaixaSaidasDeposito.wwDBGrid1DblClick(Sender: TObject);
begin
   with tblcaixaCheques do
   begin
...
procedure TBoxFinanceiroCaixaSaidasDeposito.FecharDs;
begin
...
procedure TBoxFinanceiroCaixaSaidasDeposito.AbrirDs;
begin

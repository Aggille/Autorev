object BoxCompras: TBoxCompras
  ...
  object PageControl: TPageControl
    ...
    object PageNotasFiscais: TTabSheet
      ...
      object ICMSSubst: TJvDBMaskEdit
        ...
        DataSource = DataSourceNofi
        TabOrder = 10
        OnKeyPress = TotalProdutosKeyPress
      end
    ...
    object Pageusados: TTabSheet
      ...
      object DBGrid2: TDBGrid
        ...
        Columns = <
          ...
          item
            ...
            Title.Caption = 'Ano de fabrica'#231#227'o:'
            Visible = True
          end
          item
            Expanded = False
            FieldName = 'ANO_MODELO'
            Title.Caption = 'Ano do modelo:'
            Visible = True
          end
          item
            Expanded = False
      ...
      object ModeloUsados: TRxDBLookupCombo
        Left = 84
        Top = 51
        Width = 115
        Height = 21
    ...
    object PagePecas: TTabSheet
      ...
      object Codigo: TMaskEdit
        ...
        Width = 125
        Height = 21
        EditMask = '!\ AAAAAAAAAAAAAAAAAAAA\ ;1; '
        MaxLength = 22
        TabOrder = 1
        Text = '                      '
        OnKeyPress = FormKeyPress
  ...
  object tblNofi: TIBDataSet
    ...
    InsertSQL.Strings = (
      'insert into NOFI'
        ...
        '   ID_CONCESSIONARIA, ID_CONHECIMENTO, ID_NOFI, IE_SUBS, ISSQN, ' +
        'NAT_OP, '
      
        '   NUMERO, OBS, ORIGEM, PIS, PLACA, QTDE_PROD, SAIDA, SERIE, STA' +
        'TUS, TOT_NOTA, '
      
        '   TOT_PROD, VAL_FRETE, VAL_ICMS, VAL_ICMS_S, VAL_IPI, VAL_ISS, ' +
        'VAL_OUTROS, '
      
        '   VAL_SEGURO, VAL_SERV, VAL1, VAL2, VAL3, VAL4, VAL5, VAL6, VAL' +
        '7, VAL8, '
      '   VAL9, VENDEDOR)'
      'values'
        ...
        '   :DADOS_AD01, :DADOS_AD02, :DADOS_AD03, :DADOS_AD04, :DAT1, :D' +
        'AT2, :DAT3, '
      
        '   :DAT4, :DAT5, :DAT6, :DAT7, :DAT8, :DAT9, :DESC_OFI, :DESC_PE' +
        'C, :EMISSAO, '
      
        '   :ENT_SAI, :FAT1, :FAT2, :FAT3, :FAT4, :FAT5, :FAT6, :FAT7, :F' +
        'AT8, :FAT9, '
      
        '   :FRETE_TIPO, :HORA, :ICMS, :ID_CLIENTES, :ID_CONCESSIONARIA, ' +
        ':ID_CONHECIMENTO, '
      
        '   :ID_NOFI, :IE_SUBS, :ISSQN, :NAT_OP, :NUMERO, :OBS, :ORIGEM, ' +
        ':PIS, :PLACA, '
      
        '   :QTDE_PROD, :SAIDA, :SERIE, :STATUS, :TOT_NOTA, :TOT_PROD, :V' +
        'AL_FRETE, '
      
        '   :VAL_ICMS, :VAL_ICMS_S, :VAL_IPI, :VAL_ISS, :VAL_OUTROS, :VAL' +
        '_SEGURO, '
      
        '   :VAL_SERV, :VAL1, :VAL2, :VAL3, :VAL4, :VAL5, :VAL6, :VAL7, :' +
        'VAL8, :VAL9, '
      '   :VENDEDOR)')
    RefreshSQL.Strings = (
      'Select '
    ...
    object tblNofiFAT1: TIBStringField
      FieldName = 'FAT1'
      Origin = '"NOFI"."FAT1"'
      FixedChar = True
      Size = 10
    end
    object tblNofiVAL1: TIBBCDField
      FieldName = 'VAL1'
      Origin = '"NOFI"."VAL1"'
      Precision = 18
      Size = 2
    end
    object tblNofiDAT1: TDateField
      FieldName = 'DAT1'
      Origin = '"NOFI"."DAT1"'
    end
    object tblNofiFAT2: TIBStringField
      FieldName = 'FAT2'
      Origin = '"NOFI"."FAT2"'
      FixedChar = True
      Size = 10
    end
    object tblNofiVAL2: TIBBCDField
      FieldName = 'VAL2'
      Origin = '"NOFI"."VAL2"'
      Precision = 18
      Size = 2
    end
    object tblNofiDAT2: TDateField
      FieldName = 'DAT2'
      Origin = '"NOFI"."DAT2"'
    end
    object tblNofiFAT3: TIBStringField
      FieldName = 'FAT3'
      Origin = '"NOFI"."FAT3"'
      FixedChar = True
      Size = 10
    end
    object tblNofiVAL3: TIBBCDField
      FieldName = 'VAL3'
      Origin = '"NOFI"."VAL3"'
      Precision = 18
      Size = 2
    end
    object tblNofiDAT3: TDateField
      FieldName = 'DAT3'
      Origin = '"NOFI"."DAT3"'
    end
    object tblNofiFAT4: TIBStringField
      FieldName = 'FAT4'
      Origin = '"NOFI"."FAT4"'
      FixedChar = True
      Size = 10
    end
    object tblNofiVAL4: TIBBCDField
      FieldName = 'VAL4'
      Origin = '"NOFI"."VAL4"'
      Precision = 18
      Size = 2
    end
    object tblNofiDAT4: TDateField
      FieldName = 'DAT4'
      Origin = '"NOFI"."DAT4"'
    end
    object tblNofiFAT5: TIBStringField
      FieldName = 'FAT5'
      Origin = '"NOFI"."FAT5"'
      FixedChar = True
      Size = 10
    end
    object tblNofiVAL5: TIBBCDField
      FieldName = 'VAL5'
      Origin = '"NOFI"."VAL5"'
      Precision = 18
      Size = 2
    end
    object tblNofiDAT5: TDateField
      FieldName = 'DAT5'
      Origin = '"NOFI"."DAT5"'
    end
    object tblNofiFAT6: TIBStringField
      FieldName = 'FAT6'
      Origin = '"NOFI"."FAT6"'
      FixedChar = True
      Size = 10
    end
    object tblNofiVAL6: TIBBCDField
      FieldName = 'VAL6'
      Origin = '"NOFI"."VAL6"'
      Precision = 18
      Size = 2
    end
    object tblNofiDAT6: TDateField
      FieldName = 'DAT6'
      Origin = '"NOFI"."DAT6"'
    end
    object tblNofiFAT7: TIBStringField
      FieldName = 'FAT7'
      Origin = '"NOFI"."FAT7"'
      FixedChar = True
      Size = 10
    end
    object tblNofiVAL7: TIBBCDField
      FieldName = 'VAL7'
      Origin = '"NOFI"."VAL7"'
      Precision = 18
      Size = 2
    end
    object tblNofiDAT7: TDateField
      FieldName = 'DAT7'
      Origin = '"NOFI"."DAT7"'
    end
    object tblNofiFAT8: TIBStringField
      FieldName = 'FAT8'
      Origin = '"NOFI"."FAT8"'
      FixedChar = True
      Size = 10
    end
    object tblNofiVAL8: TIBBCDField
      FieldName = 'VAL8'
      Origin = '"NOFI"."VAL8"'
      Precision = 18
      Size = 2
    end
    object tblNofiDAT8: TDateField
      FieldName = 'DAT8'
      Origin = '"NOFI"."DAT8"'
    end
    object tblNofiFAT9: TIBStringField
      FieldName = 'FAT9'
      Origin = '"NOFI"."FAT9"'
      FixedChar = True
      Size = 10
    end
    object tblNofiVAL9: TIBBCDField
      FieldName = 'VAL9'
      Origin = '"NOFI"."VAL9"'
      Precision = 18
      Size = 2
    end
    object tblNofiDAT9: TDateField
      FieldName = 'DAT9'
      Origin = '"NOFI"."DAT9"'
    end
  ...
  object tblModelos: TIBDataSet
    ...
    object tblModelosHP: TIntegerField
      FieldName = 'HP'
      Origin = '"MODVEIC"."HP"'
    end
  ...
  object tblGrid: TIBDataSet
    ...
    Left = 432
    Top = 248
    object tblGridPROD_NUMERO: TIntegerField
      DisplayLabel = 'Prod.n'#186'.:'
      FieldName = 'PROD_NUMERO'
      Origin = '"DADOS_NFE"."PROD_NUMERO"'
    end
    object tblGridMODELO: TIBStringField
      DisplayLabel = 'Modelo:'
      FieldName = 'MODELO'
      Origin = '"DADOS_NFE"."MODELO"'
    end
    object tblGridITEM: TIBStringField
      DisplayLabel = 'Chassi:'
      FieldName = 'ITEM'
      Origin = '"DADOS_NFE"."ITEM"'
    end
    object tblGridVLR_UNIT: TIBBCDField
    ...
    object tblGridANO_FABRICACAO: TIBStringField
      DisplayLabel = 'Ano Fabrica'#231#227'o:'
      FieldName = 'ANO_FABRICACAO'
      Origin = '"DADOS_NFE"."ANO_FABRICACAO"'
      Size = 4
    end
    object tblGridANO_MODELO: TIBStringField
      DisplayLabel = 'Ano modelo:'
      FieldName = 'ANO_MODELO'
      Origin = '"DADOS_NFE"."ANO_MODELO"'
      Size = 4
    end
    object tblGridCOR: TIBStringField
      DisplayLabel = 'Cor:'
      FieldName = 'COR'
      Origin = '"DADOS_NFE"."COR"'
      Size = 10
    end
    object tblGridMOTOR: TIBStringField
      DisplayLabel = 'N'#186' motor:'
      FieldName = 'MOTOR'
      Origin = '"DADOS_NFE"."MOTOR"'
      Size = 15
    end
    object tblGridID_DADOS_NFE: TIntegerField
      FieldName = 'ID_DADOS_NFE'
      Origin = '"DADOS_NFE"."ID_DADOS_NFE"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object tblGridID_CONCESSIONARIA: TIntegerField
      FieldName = 'ID_CONCESSIONARIA'
      Origin = '"DADOS_NFE"."ID_CONCESSIONARIA"'
      Required = True
    end
    object tblGridID_NOFI: TIntegerField
      FieldName = 'ID_NOFI'
      Origin = '"DADOS_NFE"."ID_NOFI"'
      Required = True
    end
    object tblGridID_CONHECIMENTO: TIntegerField
      FieldName = 'ID_CONHECIMENTO'
      Origin = '"DADOS_NFE"."ID_CONHECIMENTO"'
      Required = True
    end
    object tblGridNF: TIBStringField
      FieldName = 'NF'
      Origin = '"DADOS_NFE"."NF"'
      Size = 8
    end
    object tblGridQTDE: TIntegerField
      FieldName = 'QTDE'
      Origin = '"DADOS_NFE"."QTDE"'
    end
    object tblGridCST: TIBStringField
      FieldName = 'CST'
      Origin = '"DADOS_NFE"."CST"'
      Size = 3
    end
    object tblGridCFOP: TIntegerField
      FieldName = 'CFOP'
      Origin = '"DADOS_NFE"."CFOP"'
      Required = True
    end
    object tblGridBASE_ICMS: TIBBCDField
      FieldName = 'BASE_ICMS'
      Origin = '"DADOS_NFE"."BASE_ICMS"'
      Precision = 18
      Size = 2
    end
    object tblGridALIQ_ICMS: TIBBCDField
      FieldName = 'ALIQ_ICMS'
      Origin = '"DADOS_NFE"."ALIQ_ICMS"'
      Precision = 9
      Size = 2
    end
    object tblGridVLR_ICMS: TIBBCDField
      FieldName = 'VLR_ICMS'
      Origin = '"DADOS_NFE"."VLR_ICMS"'
      Precision = 18
      Size = 2
    end
    object tblGridVLR_IPI: TIBBCDField
      FieldName = 'VLR_IPI'
      Origin = '"DADOS_NFE"."VLR_IPI"'
      Precision = 18
      Size = 2
    end
    object tblGridCOMBUSTIVEL: TIBStringField
      FieldName = 'COMBUSTIVEL'
      Origin = '"DADOS_NFE"."COMBUSTIVEL"'
    end
    object tblGridMARCA: TIBStringField
      FieldName = 'MARCA'
      Origin = '"DADOS_NFE"."MARCA"'
      Size = 10
    end
    object tblGridPOTENCIA: TIBStringField
      FieldName = 'POTENCIA'
      Origin = '"DADOS_NFE"."POTENCIA"'
      Size = 3
    end
    object tblGridRENAVAM: TIBStringField
      FieldName = 'RENAVAM'
      Origin = '"DADOS_NFE"."RENAVAM"'
      Size = 15
    end

object BoxDebitoCliente: TBoxDebitoCliente
  Left = 5
  Top = 85
  ...
  object Panel1: TPanel
    ...
    object CodigoCliente: TMaskEdit
      ...
      TabOrder = 0
      OnClick = CodigoClienteClick
      OnExit = CodigoClienteExit
      OnKeyPress = FormKeyPress
      OnMouseEnter = CodigoClienteClick
    end
    object Documento: TJvDBMaskEdit
      Left = 78
      Top = 66
      Width = 78
      Height = 21
    ...
    object CodigoAvalista: TMaskEdit
      Left = 78
      Top = 39
      Width = 48
      Height = 21
    ...
    object NomeAvalista: TJvDBMaskEdit
      Left = 250
      Top = 39
      Width = 390
      Height = 21
  ...
  object tblCReceber: TIBDataSet
    ...
    InsertSQL.Strings = (
      'insert into CReceber'
        ...
        '  (BANCO, CONTA, DOCUMENTO, EMISSAO, FORMA_PAG, HISTORICO, ID_AV' +
        'ALISTA, '
      
        '   ID_CLIENTES, ID_CONCESSIONARIA, ID_CRECEBER, ID_PEDIDO_VEICUL' +
        'OS, ORIGEM, '
      
        '   PAGAMENTO, PARCELA, STATUS, TOTAL, VALOR, VALOR_PAGO, VENCIME' +
        'NTO, VEZES)'
      'values'
      
        '  (:BANCO, :CONTA, :DOCUMENTO, :EMISSAO, :FORMA_PAG, :HISTORICO,' +
        ' :ID_AVALISTA, '
      
        '   :ID_CLIENTES, :ID_CONCESSIONARIA, :ID_CRECEBER, :ID_PEDIDO_VE' +
        'ICULOS, '
    ...
    object tblCReceberFORMA_PAG: TIBStringField
      FieldName = 'FORMA_PAG'
      Origin = '"CRECEBER"."FORMA_PAG"'
      FixedChar = True
      Size = 10
    end

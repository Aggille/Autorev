object BoxComprasPecasXML: TBoxComprasPecasXML
  ...
  object tblPecas2: TIBDataSet
    ...
    object tblPecas2VBC_STRET: TIBBCDField
      FieldName = 'VBC_STRET'
      Origin = '"PECAS"."VBC_STRET"'
      Precision = 18
      Size = 2
    end
    object tblPecas2PST: TIBBCDField
      FieldName = 'PST'
      Origin = '"PECAS"."PST"'
      Precision = 9
      Size = 2
    end
    object tblPecas2VICMS_STRET: TIBBCDField
      FieldName = 'VICMS_STRET'
      Origin = '"PECAS"."VICMS_STRET"'
      Precision = 18
      Size = 2
    end
    object tblPecas2PMVAST: TIBBCDField
      FieldName = 'PMVAST'
      Origin = '"PECAS"."PMVAST"'
      Precision = 9
      Size = 2
    end
    object tblPecas2PRED_BCST: TIBBCDField
      FieldName = 'PRED_BCST'
      Origin = '"PECAS"."PRED_BCST"'
      Precision = 9
      Size = 2
    end
    object tblPecas2VBC_ST: TIBBCDField
      FieldName = 'VBC_ST'
      Origin = '"PECAS"."VBC_ST"'
      Precision = 18
      Size = 2
    end
    object tblPecas2PICMS_ST: TIBBCDField
      FieldName = 'PICMS_ST'
      Origin = '"PECAS"."PICMS_ST"'
      Precision = 9
      Size = 2
    end
    object tblPecas2VICMS_ST: TIBBCDField
      FieldName = 'VICMS_ST'
      Origin = '"PECAS"."VICMS_ST"'
      Precision = 18
      Size = 2

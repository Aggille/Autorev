object BoxFinanceiroCaixaSaidasTaxas: TBoxFinanceiroCaixaSaidasTaxas
  Left = 15
  Top = 215
  Caption = 'Sa'#237'das de caixa - Taxas'
  ClientHeight = 324
  ClientWidth = 569
  Color = clBtnFace
  ...
  object tblPedidoVeiculosAcessorios: TIBDataSet
    ...
    InsertSQL.Strings = (
      'insert into PEDIDO_VEICULOS_ACESSORIOS'
        ...
        '  (CUSTO, DESCRICAO_ACESSORIO, ENTREGA, ID_PEDIDO_VEICULOS, ID_P' +
        'EDIDO_VEICULOS_ACESSORIOS, '
      '   ID_VEICULOS_ACESSORIOS, VALOR_ACESSORIO)'
      'values'
      
        '  (:CUSTO, :DESCRICAO_ACESSORIO, :ENTREGA, :ID_PEDIDO_VEICULOS, ' +
    ...
    SelectSQL.Strings = (
      ...
      'where  id_Veiculos_Acessorios = 2')
    ModifySQL.Strings = (

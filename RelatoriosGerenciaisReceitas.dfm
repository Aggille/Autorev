object BoxRelatoriosGerenciaisReceitas: TBoxRelatoriosGerenciaisReceitas
  ...
  object GroupBox2: TGroupBox
    ...
    object Panel2: TPanel
      ...
      object Resumido: TCheckBox
        Left = 72
        Top = 36
        Width = 121
        Height = 17
        Caption = 'Relat'#243'rio resumido'
        TabOrder = 2
      end
      object Garantia: TCheckBox
        Left = 72
        Top = 59
        Width = 121
        Height = 17
        Caption = 'Incluir Garantias'
        TabOrder = 3
      end
      object devolucoes: TCheckBox
        Left = 72
        Top = 82
        Width = 121
        Height = 17
    ...
    object Page1: TfrxReportPage
      ...
      object Band7: TfrxGroupFooter
        ...
        object Memo28: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              'Total pe'#231'as desta concession'#225'ria: [Sum(<tblRelNofisa."Tot_Prod">' +
              ')]'
            
              'Total servi'#231'os desta concession'#225'ria: [Sum(<tblRelNofisa."Val_Ser' +
              'v">)]')
        end
      end
      object Band8: TfrxGroupFooter
        ...
        object Memo15: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            'Total de pe'#231'as: [Sum(<tblRelNofisa."TOT_PROD">)]'
            'Total de servi'#231'os: [Sum(<tblRelNofisa."Val_Serv">)]'
            '')
          ParentFont = False
        end
      end
      ...
      object Footer1: TfrxFooter
        ...
        object Memo14: TfrxMemoView
          ...
          Fill.BackColor = clMaroon
          Memo.UTF8W = (
            'Total pe'#231'as do grupo: [Sum(<tblRelNofisa."Tot_Prod">)]'
            'Total servi'#231'os do grupo: [Sum(<tblRelNofisa."Val_Serv">)]')
          ParentFont = False
        end
      end
  ...
  object tblNofisa2: TIBDataSet
    ...
    SelectSQL.Strings = (
      ...
      'N.ENT_SAI = '#39'S'#39
      'and'
      '(N.Origem = '#39'O'#39' or N.Origem = '#39'P'#39' or n.origem = '#39'G'#39')'
      'and'
      'n.CODIGO_FISCAL <> '#39'5152'#39
      'and'
      'n.CODIGO_FISCAL <> '#39'5409'#39
  ...
  object tblNofisa3: TIBDataSet
    ...
    SelectSQL.Strings = (
      ...
      '(N.Origem = '#39'O'#39' or N.Origem = '#39'P'#39')'
      'and'
      '(n.CODIGO_FISCAL = '#39'1662'#39
      'or'
      'n.CODIGO_FISCAL = '#39'1411'#39
      'or'
      'CODIGO_FISCAL = '#39'1662/1411'#39
      'or'
      'CODIGO_FISCAL=  '#39'1411/1662'#39')'
      'and'
      '(n.STATUS = '#39'NF-e Autorizada'#39
      'or'
      'n.STATUS = '#39'Processado'#39')'
  ...
  object DataSourceNofisa3: TDataSource
    AutoEdit = False
    DataSet = tblNofisa3
    Left = 288
    Top = 128

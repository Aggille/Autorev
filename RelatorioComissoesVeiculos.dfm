object BoxComissaoVeiculos: TBoxComissaoVeiculos
  Left = 0
  Top = 85
  Caption = 'BoxComissaoVeiculos'
  ClientHeight = 412
  ClientWidth = 1030
  Color = clBtnFace
  ...
  object DBGrid1: TDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'TABELA_VIP'
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'TABELA_NORMAL'
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'TABELA_EXCLUSIVA'
        Visible = True
      end
      item
        Expanded = False
  ...
  object tblComissoes: TIBDataSet
    ...
    BeforeCancel = tblPessoasBeforeCancel
    BufferChunks = 1000
    CachedUpdates = False
    DeleteSQL.Strings = (
      'delete from Comissoes'
      'where'
      '  ID_COMISSOES = :OLD_ID_COMISSOES')
    InsertSQL.Strings = (
      'insert into Comissoes'
      
        '  (ID_COMISSOES, ID_PEDIDO, ID_VENDEDOR, ID_CLIENTES, MODELO, AN' +
        'O_FABRICACAO, '
      
        '   ANO_MODELO, CHASSI, VALOR_VENDA, BASE_COMISSAO, TABELA_VIP, T' +
        'ABELA_NORMAL, '
      
        '   TABELA_EXCLUSIVA, PERCENTUAL, VALOR_COMISSAO, PERIODO, ORIGEM' +
        ')'
      'values'
      
        '  (:ID_COMISSOES, :ID_PEDIDO, :ID_VENDEDOR, :ID_CLIENTES, :MODEL' +
        'O, :ANO_FABRICACAO, '
      
        '   :ANO_MODELO, :CHASSI, :VALOR_VENDA, :BASE_COMISSAO, :TABELA_V' +
        'IP, :TABELA_NORMAL, '
      
        '   :TABELA_EXCLUSIVA, :PERCENTUAL, :VALOR_COMISSAO, :PERIODO, :O' +
        'RIGEM)')
    RefreshSQL.Strings = (
      'Select *'
      'from Comissoes '
      'where'
      '  ID_COMISSOES = :ID_COMISSOES')
    SelectSQL.Strings = (
      'Select comissoes.*, clientes.nome'
      'from Comissoes'
      'inner join Clientes on'
      '(clientes.id_clientes = comissoes.id_clientes)'
      'where '
      'id_vendedor = :idvendedor'
      'order by comissoes.origem')
    ModifySQL.Strings = (
      'update Comissoes'
      'set'
      '  ID_COMISSOES = :ID_COMISSOES,'
      ...
      '  TABELA_VIP = :TABELA_VIP,'
      '  TABELA_NORMAL = :TABELA_NORMAL,'
      '  TABELA_EXCLUSIVA = :TABELA_EXCLUSIVA,'
    ...
    Left = 624
    Top = 72
    object tblComissoesID_COMISSOES: TIntegerField
      FieldName = 'ID_COMISSOES'
      Origin = '"COMISSOES"."ID_COMISSOES"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
    end
    object tblComissoesID_PEDIDO: TIntegerField
      FieldName = 'ID_PEDIDO'
      Origin = '"COMISSOES"."ID_PEDIDO"'
      Required = True
    end
    object tblComissoesID_VENDEDOR: TIntegerField
      FieldName = 'ID_VENDEDOR'
      Origin = '"COMISSOES"."ID_VENDEDOR"'
      Required = True
    end
    object tblComissoesID_CLIENTES: TIntegerField
      FieldName = 'ID_CLIENTES'
      Origin = '"COMISSOES"."ID_CLIENTES"'
      Required = True
    end
    object tblComissoesMODELO: TIBStringField
      FieldName = 'MODELO'
      Origin = '"COMISSOES"."MODELO"'
    end
    object tblComissoesANO_FABRICACAO: TIBStringField
      FieldName = 'ANO_FABRICACAO'
      Origin = '"COMISSOES"."ANO_FABRICACAO"'
      Size = 4
    end
    object tblComissoesANO_MODELO: TIBStringField
      FieldName = 'ANO_MODELO'
      Origin = '"COMISSOES"."ANO_MODELO"'
      Size = 4
    end
    object tblComissoesCHASSI: TIBStringField
      FieldName = 'CHASSI'
      Origin = '"COMISSOES"."CHASSI"'
    end
    object tblComissoesVALOR_VENDA: TIBBCDField
      FieldName = 'VALOR_VENDA'
      Origin = '"COMISSOES"."VALOR_VENDA"'
      currency = True
      Precision = 18
      Size = 2
    end
    object tblComissoesBASE_COMISSAO: TIBBCDField
      FieldName = 'BASE_COMISSAO'
      Origin = '"COMISSOES"."BASE_COMISSAO"'
      currency = True
      Precision = 18
      Size = 2
    end
    object tblComissoesTABELA_VIP: TIBBCDField
      FieldName = 'TABELA_VIP'
      Origin = '"COMISSOES"."TABELA_VIP"'
      currency = True
      Precision = 18
      Size = 2
    end
    object tblComissoesTABELA_NORMAL: TIBBCDField
      FieldName = 'TABELA_NORMAL'
      Origin = '"COMISSOES"."TABELA_NORMAL"'
      currency = True
      Precision = 18
      Size = 2
    end
    object tblComissoesTABELA_EXCLUSIVA: TIBBCDField
      FieldName = 'TABELA_EXCLUSIVA'
      Origin = '"COMISSOES"."TABELA_EXCLUSIVA"'
      currency = True
      Precision = 18
      Size = 2
    end
    object tblComissoesPERCENTUAL: TIBBCDField
      FieldName = 'PERCENTUAL'
      Origin = '"COMISSOES"."PERCENTUAL"'
      Precision = 9
      Size = 2
    end
    object tblComissoesVALOR_COMISSAO: TIBBCDField
      FieldName = 'VALOR_COMISSAO'
      Origin = '"COMISSOES"."VALOR_COMISSAO"'
      currency = True
      Precision = 18
      Size = 2
    end
    object tblComissoesPERIODO: TIBStringField
      DisplayWidth = 5
      FieldName = 'PERIODO'
      Origin = '"COMISSOES"."PERIODO"'
      Size = 5
    end
    ...
    object tblComissoesORIGEM: TIBStringField
      FieldName = 'ORIGEM'
      Origin = '"COMISSOES"."ORIGEM"'
      Size = 1
    end
  end
  ...
  object tblPedidoVeiculos: TIBDataSet
    ...
    InsertSQL.Strings = (
      'insert into Pedido_Veiculos'
        ...
        '  (ID_PEDIDO_VEICULOS, CHASSI, MODELO, ID_CONCESSIONARIA, ID_CLI' +
        'ENTES, '
      
        '   ID_VEICULOS, ID_AVALISTA, ID_VENDEDOR, ID_FINANCEIRA, MARCA, ' +
        'ANO_MODELO, '
      
        '   ANO_FABRICACAO, PLACA, VALOR, BASE_COMISSAO, NF, DATA_NF, STA' +
        'TUS, VALOR_DA_VENDA, '
      
        '   VALOR_A_RECEBER, MOTOR, ID_USUARIO, USUARIO, COR, NF_CANCELAM' +
        'ENTO, DATA_NF_CANCELAMENTO, '
      
        '   VALOR_VIP, VALOR_NORMAL, VALOR_EXCLUSIVO, VALOR_VIP2, VALOR_N' +
        'ORMAL2, '
      
        '   VALOR_EXCLUSIVO2, RENAVAM, VALOR_TAXAS, ID_MODELO_VEICULO, FO' +
        'RMA_VISITA, '
      '   ID_VEICULO_USADO, DATA_PEDIDO)'
      'values'
      
        '  (:ID_PEDIDO_VEICULOS, :CHASSI, :MODELO, :ID_CONCESSIONARIA, :I' +
        'D_CLIENTES, '
      
        '   :ID_VEICULOS, :ID_AVALISTA, :ID_VENDEDOR, :ID_FINANCEIRA, :MA' +
        'RCA, :ANO_MODELO, '
      
        '   :ANO_FABRICACAO, :PLACA, :VALOR, :BASE_COMISSAO, :NF, :DATA_N' +
        'F, :STATUS, '
      
        '   :VALOR_DA_VENDA, :VALOR_A_RECEBER, :MOTOR, :ID_USUARIO, :USUA' +
        'RIO, :COR, '
      
        '   :NF_CANCELAMENTO, :DATA_NF_CANCELAMENTO, :VALOR_VIP, :VALOR_N' +
        'ORMAL, '
      
        '   :VALOR_EXCLUSIVO, :VALOR_VIP2, :VALOR_NORMAL2, :VALOR_EXCLUSI' +
        'VO2, :RENAVAM, '
      
        '   :VALOR_TAXAS, :ID_MODELO_VEICULO, :FORMA_VISITA, :ID_VEICULO_' +
        'USADO, '
      '   :DATA_PEDIDO)')
    RefreshSQL.Strings = (
      'Select *'
    ...
    SelectSQL.Strings = (
      'select Pedido_veiculos.*, Clientes.Nome, veiculos.origem'
      'from Pedido_Veiculos'
      
        'inner join Clientes on (Clientes.Id_Clientes = Pedido_Veiculos.I' +
        'd_Clientes)'
      
        'inner join Veiculos on (Veiculos.Id_veiculos = Pedido_Veiculos.I' +
        'd_Veiculos)'
      'where '
      'Data_NF >= :DataInicial'
      'and'
      'Data_NF <= :DataFinal'
      'and'
      '(pedido_veiculos.Status = '#39'Fechado'#39' or'
      'pedido_veiculos.Status = '#39'Faturado'#39')'
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 43860.744517673610000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'var comissao : variant;'
      'procedure Memo30OnBeforePrint(Sender: TfrxComponent);'
      'begin'
      
        '//  comissao := (percentual * <tblRelPedidoVeiculos."BASE_COMISS' +
        'AO">)/100;                                                      ' +
        '                                                                ' +
        '             '
      'end;'
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object tblRelPecasEstoqueID_PECAS_ESTOQUE: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[tblRelPedidoVeiculos."ID_PEDIDO"]')
          ParentFont = False
        end
        ...
        object Memo23: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[tblRelPedidoVeiculos."TABELA_VIP"]')
          ParentFont = False
        end
        object Memo26: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[tblRelPedidoVeiculos."TABELA_EXCLUSIVA"]')
          ParentFont = False
        end
        object Memo29: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[tblRelPedidoVeiculos."PERCENTUAL"]')
          ParentFont = False
        end
        object Memo30: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[tblRelPedidoVeiculos."VALOR_COMISSAO"]')
          ParentFont = False
        end
        object Memo35: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[tblRelPedidoVeiculos."TABELA_NORMAL"]')
          ParentFont = False
        end
      end
      object GroupFooter1: TfrxGroupFooter
        ...
        object Memo14: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            'Total:[SUM(<tblRelPedidoVeiculos."VALOR_VENDA">)]')
          ParentFont = False
        end
        object Memo31: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            'Total:[SUM(<tblRelPedidoVeiculos."valor_comissao">)]')
          ParentFont = False
        end
        object Memo33: TfrxMemoView
          Left = 257.008040000000000000
          Top = 90.708719999999910000
          Width = 275.905690000000000000
          Height = 18.897650000000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
  ...
  object tblRelVendedor: TfrxDBDataset
    UserName = 'tblRelVendedor'
    CloseDataSource = False
    FieldAliases.Strings = (
      'ID_CLIENTES=ID_CLIENTES'
      'CODIGO=CODIGO'
  ...
  object tblPedidoVeiculosRecebimento: TIBDataSet
    ...
    SelectSQL.Strings = (
      ...
      'where'
        ...
        'Pedido_veiculos_recebimento.Id_Pedido_veiculos = :idPedidoVeicul' +
        'os '
      'and numero_cv is not null')
    ParamCheck = True
    UniDirectional = False
    Left = 616
    Top = 224
  ...
  object tblAux: TClientDataSet
    PersistDataPacket.Data = {
      
      00}
    Active = True
    Aggregates = <>
    FieldDefs = <
    ...
    Left = 896
    Top = 320
    object tblAuxID_RECEBIMENTO: TIntegerField
      FieldName = 'ID_RECEBIMENTO'
    end
    object tblAuxNUMERO_CV: TStringField
      FieldName = 'NUMERO_CV'
    end
    object tblAuxVALOR_PARCELAS: TCurrencyField
      FieldName = 'VALOR_PARCELAS'
    end
    object tblAuxNUMERO_PARCELAS: TIntegerField
      FieldName = 'NUMERO_PARCELAS'
    end
    object tblAuxVALOR_ORIGINAL: TCurrencyField
      FieldName = 'VALOR_ORIGINAL'
    end
  end
  object dtsAuxRecebimentos: TDataSource
    DataSet = tblAux
    Left = 896
    Top = 272
  end

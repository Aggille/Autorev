object BoxRelatoriosGerenciaisDespesas: TBoxRelatoriosGerenciaisDespesas
  Left = 15
  Top = 85
  Caption = 'Relat'#243'rios gerenciais - despesas'
  ClientHeight = 124
  ClientWidth = 375
  Color = clBtnFace
  ...
  object tblDespesas: TIBDataSet
    ...
    SelectSQL.Strings = (
      ...
      ''
        ...
        'd.CONTA, d.DATA, d.HISTORICO, d.ID_CONCESSIONARIA, d.ID_DESPESAS' +
        ', d.SETOR, d.VALOR,'
      'p.descricao, c.EMPRESA, c.Cidade'
      ''
      ''
      'from DESPESAS d'
      ''
      'inner join placon p  on d.conta = p.conta'
        ...
        'inner join Concessionaria c on d.id_concessionaria = c.id_conces' +
        'sionaria'
      ''
      'where'
      'd.Data >= :DataInicial'
      ...
      ''
      'order by d.Id_Concessionaria, p.conta ')
    ModifySQL.Strings = (
      'update DESPESAS'
      'set'
      '  CONTA = :CONTA,'
    ...
    object tblDespesasDESCRICAO: TIBStringField
      FieldName = 'DESCRICAO'
      Origin = '"PLACON"."DESCRICAO"'
      Required = True
      Size = 50
    end
    object tblDespesasEMPRESA: TIBStringField
      FieldName = 'EMPRESA'
      Origin = '"CONCESSIONARIA"."EMPRESA"'
      Required = True
      Size = 50
    end
    object tblDespesasCIDADE: TIBStringField
      FieldName = 'CIDADE'
      Origin = '"CONCESSIONARIA"."CIDADE"'
    end
  end
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.Description.Strings = (
        ...
        '.')
    ReportOptions.LastChange = 40209.964196747690000000
    ...
    Datasets = <
      ...
      item
        DataSet = tblRelPlacon
        DataSetName = 'tblRelPlacon'
      end>
    Variables = <>
    Style = <>
    ...
    object Page1: TfrxReportPage
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        Width = 755.906000000000000000
        Condition = 'tblRelDespesas."Id_Concessionaria"'
        StartNewPage = True
        ...
        object Memo39: TfrxMemoView
          ...
          GapX = 6.000000000000000000
          Memo.UTF8 = (
            '[(<tblRelDespesas."EMPRESA">)]  -  [(<tblRelDespesas."CIDADE">)]')
          ParentFont = False
          VAlign = vaCenter
        end
      end
      object GroupHeader2: TfrxGroupHeader
        ...
        Width = 755.906000000000000000
        Condition = 'tblRelDespesas."CONTA"'
        object Memo25: TfrxMemoView
          ...
          Memo.UTF8 = (
              ...
              'Conta: [(<tblRelDespesas."CONTA">)] - [(<tblRelDespesas."DESCRIC' +
              'AO">)]')
          ParentFont = False
        end
      end
      ...
      object Band7: TfrxGroupFooter
        ...
        object Memo28: TfrxMemoView
          ...
          Memo.UTF8 = (
            'Total desta concession'#195#161'ria: [Sum(<tblRelDespesas."Valor">)]')
        end
      end
      object Band8: TfrxGroupFooter
        ...
        object Memo15: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8 = (
            'Total desta conta: [Sum(<tblRelDespesas."Valor">)]')
          ParentFont = False
        end
      end
      object PageHeader1: TfrxPageHeader
        ...
        object Memo22: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8 = (
            '41 - Relat'#195#179'rio de despesas:')
          ParentFont = False
        end
      ...
      object Footer1: TfrxFooter
        ...
        object Memo2: TfrxMemoView
          ...
          Frame.Typ = [ftLeft, ftRight, ftBottom]
          Memo.UTF8 = (
            'Total do grupo: [Sum(<tblRelDespesas."Valor">)]')
          ParentFont = False
        end
      end
    end
  ...
  object tblRelPlacon: TfrxDBDataset
    UserName = 'tblRelPlacon'
    CloseDataSource = False
    FieldAliases.Strings = (
      'ID_PLACON=ID_PLACON'
      'CONTA=CONTA'

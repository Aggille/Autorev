unit FinanceiroCaixaSaidasTaxas;
...
type
  TBoxFinanceiroCaixaSaidasTaxas = class(TForm)
...
var
  Retorno : String;
  BoxFinanceiroCaixaSaidasTaxas: TBoxFinanceiroCaixaSaidasTaxas;
...
procedure TBoxFinanceiroCaixaSaidasTaxas.BtnConfirmaClick(Sender: TObject);
begin
...
procedure TBoxFinanceiroCaixaSaidasTaxas.GravaDados;
var
   mDocumento : String;
   mData : TDateTime;
   mConta : String;
...
TRY
  ...
  begin
    Edit;
    FieldByName('Custo').AsCurrency :=  dinheiro.value;
    Post;
  end;
...
procedure TBoxFinanceiroCaixaSaidasTaxas.CodigoContaExit(Sender: TObject);
begin
...
procedure TBoxFinanceiroCaixaSaidasTaxas.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  Fdb1.IBTransaction.RollbackRetaining;
  FecharDs;
  Action :=caFree;
  BoxFinanceiroCaixaSaidasTaxas := nil;
end;

procedure TBoxFinanceiroCaixaSaidasTaxas.FormKeyPress(Sender: TObject;
  var Key: Char);
begin
  if Key = #27 then
   begin
...
procedure TBoxFinanceiroCaixaSaidasTaxas.FormShow(Sender: TObject);
begin
  AbrirDs;
  Inicio;
end;

procedure TBoxFinanceiroCaixaSaidasTaxas.Inicio;
begin
  Dinheiro.Value := 0;
//  Cheque.Value := 0;
  NomeConta.Text := '';
...
procedure TBoxFinanceiroCaixaSaidasTaxas.SpeedButton1Click(Sender: TObject);
begin
...
procedure TBoxFinanceiroCaixaSaidasTaxas.tblCaixaAfterCancel(
  DataSet: TDataSet);
begin
  Fdb1.IBTransaction.RollbackRetaining;
end;

procedure TBoxFinanceiroCaixaSaidasTaxas.tblCaixaAfterPost(
  DataSet: TDataSet);
begin
   Fdb1.IBTransaction.CommitRetaining;
end;

procedure TBoxFinanceiroCaixaSaidasTaxas.FecharDs;
begin
...
procedure TBoxFinanceiroCaixaSaidasTaxas.AbrirDs;
begin

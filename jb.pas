   ...
   begin
      ...
      begin
         ...
         begin
           ...
           frmSPED_Fiscal.StatusBar1.SimpleText := 'Gerando emitidas registro C100... ' + IntToStr( INotas ) + ' de ' + IntToStr( t ) + ' Nº ' + qryNF.FieldByName('Numero').AsString;;
      ...
      begin
         ...
         begin
           ...
           frmSPED_Fiscal.StatusBar1.SimpleText := 'Gerando entradas registro C100... ' + IntToStr( INotas ) + ' de ' + IntToStr( t ) + ' Nº ' + qryNFe.FieldByName('Numero').AsString;;
           progresso.Position := iNotas;
           application.ProcessMessages;
           // NOTAS FISCAIS DE SAIDA
           with RegistroC100New do

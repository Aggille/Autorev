...
begin
  ...
  application.ProcessMessages;
  arq := ExtractFileName( edtNomeArq.Text );
  arq := arq + '_PIS_COFINS.TXT';
...
//                 IND_PGTO      := TSped.tpSemPagamento;
                 VL_DESC       := 0;
                 VL_BC_PIS     := fieldbyname( 'tot_nota').asCurrency;;
                 VL_PIS        := fieldbyname( 'pis').asCurrency;;
                 VL_BC_COFINS  := fieldbyname( 'tot_nota').asCurrency;;
                 VL_COFINS     := fieldbyname( 'cofins').asCurrency;;
                 VL_PIS_RET    := 0;
                 VL_COFINS_RET := 0;

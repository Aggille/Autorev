object BoxCadastroBAE: TBoxCadastroBAE
  Left = 15
  Top = 85
  Caption = 'Cadastro de BAE - Boletim de anomalia de estoque'
  ClientHeight = 363
  ClientWidth = 721
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object wwDBGrid1: TwwDBGrid
      ...
      Height = 160
      Selected.Strings = (
        'ID_BAE'#9'10'#9'ID_BAE'#9'F'
        'ID_BAE_DADOS'#9'10'#9'ID_BAE_DADOS'#9'F'
        'ID_PECAS'#9'10'#9'ID_PECAS'#9'F'
    ...
    object Observacao: TJvDBMaskEdit
      Left = 277
      Top = 40
      Width = 368
      Height = 21
  ...
  object tblBAE: TIBDataSet
    Database = FDB1.IBDatabase
    Transaction = FDB1.IBTransaction
    AfterCancel = tblBAEDadosAfterCancel
    AfterDelete = tblBAEDadosAfterPost
    AfterPost = tblBAEDadosAfterPost
    BufferChunks = 1000
    CachedUpdates = False
    DeleteSQL.Strings = (
      'delete from BAE'
    ...
    InsertSQL.Strings = (
      'insert into BAE'
      '  (DATA, ID_BAE, ID_CONCESSIONARIA, OBSERVACAO, STATUS)'
      'values'
      '  (:DATA, :ID_BAE, :ID_CONCESSIONARIA, :OBSERVACAO, :STATUS)')
    RefreshSQL.Strings = (
      'Select '
    ...
    Left = 328
    Top = 32
    object tblBAEID_BAE: TIntegerField
      FieldName = 'ID_BAE'
      Origin = '"BAE"."ID_BAE"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object tblBAESTATUS: TIBStringField
      FieldName = 'STATUS'
      Origin = '"BAE"."STATUS"'
    end
    object tblBAEDATA: TDateField
      FieldName = 'DATA'
      Origin = '"BAE"."DATA"'
    end
    object tblBAEID_CONCESSIONARIA: TIntegerField
      FieldName = 'ID_CONCESSIONARIA'
      Origin = '"BAE"."ID_CONCESSIONARIA"'
      Required = True
    end
    object tblBAEOBSERVACAO: TIBStringField
      FieldName = 'OBSERVACAO'
      Origin = '"BAE"."OBSERVACAO"'
      Size = 50
    end
    object tblBAEEMPRESA: TIBStringField
      FieldName = 'EMPRESA'
      Origin = '"CONCESSIONARIA"."EMPRESA"'
      Size = 50
    end
    object tblBAECIDADE: TIBStringField
      FieldName = 'CIDADE'
      Origin = '"CONCESSIONARIA"."CIDADE"'
    end
  end
  object DataSourceBAE: TDataSource
    DataSet = tblBAE
    Left = 296
    Top = 32
  end
  ...
  object DataSourceBAEDados: TDataSource
    DataSet = tblBAEDados
    Left = 184
    Top = 248
  end
  object tblBAEDados: TIBDataSet
    Database = FDB1.IBDatabase
    Transaction = FDB1.IBTransaction
    AfterCancel = tblBAEDadosAfterCancel
    AfterDelete = tblBAEDadosAfterPost
    ...
    CachedUpdates = False
    DeleteSQL.Strings = (
      'delete from BAE_DADOS'
      'where'
      '  ID_BAE_DADOS = :OLD_ID_BAE_DADOS')
    InsertSQL.Strings = (
      'insert into BAE_DADOS'
      '  (CUSTO, ID_BAE, ID_BAE_DADOS, ID_PECAS, QUANTIDADE)'
      'values'
      '  (:CUSTO, :ID_BAE, :ID_BAE_DADOS, :ID_PECAS, :QUANTIDADE)')
    RefreshSQL.Strings = (
      'Select '
      ...
      'from BAE_DADOS '
      'where'
      '  ID_BAE_DADOS = :ID_BAE_DADOS')
    SelectSQL.Strings = (
      'select p.codigo, p.descricao, bd.* from BAE_DADOS bd'
      'left join pecas p on (p.id_pecas = bd.id_pecas)'
      'where bd.id_BAE = :IdBAE')
    ModifySQL.Strings = (
      'update BAE_DADOS'
      'set'
      '  CUSTO = :CUSTO,'
    ...
    Left = 216
    Top = 248
    object tblBAEDadosID_BAE_DADOS: TIntegerField
      FieldName = 'ID_BAE_DADOS'
      Origin = '"BAE_DADOS"."ID_BAE_DADOS"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
    end
    object tblBAEDadosID_BAE: TIntegerField
      FieldName = 'ID_BAE'
      Origin = '"BAE_DADOS"."ID_BAE"'
      Required = True
    end
    object tblBAEDadosID_PECAS: TIntegerField
      FieldName = 'ID_PECAS'
      Origin = '"BAE_DADOS"."ID_PECAS"'
      Required = True
    end
    object tblBAEDadosQUANTIDADE: TIntegerField
      FieldName = 'QUANTIDADE'
      Origin = '"BAE_DADOS"."QUANTIDADE"'
    end
    object tblBAEDadosCODIGO: TIBStringField
      FieldKind = fkLookup
      FieldName = 'CODIGO'
    ...
    object tblBAEDadosCUSTO: TIBBCDField
      FieldName = 'CUSTO'
      Origin = '"BAE_DADOS"."CUSTO"'
      Precision = 18
      Size = 2
    end
    object tblBAEDadosDESCRICAO: TIBStringField
      FieldName = 'DESCRICAO'
      Origin = '"PECAS"."DESCRICAO"'
      Size = 60
    end
  ...
  object IBQuery1: TIBQuery
    ...
    ParamCheck = True
    SQL.Strings = (
      'SELECT GEN_ID(Seq_BAE_Id, 1) as'
      'Id_BAE From RDB$DATABASE')
    Left = 328
    Top = 64
  end
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.Description.Strings = (
        ...
        '.')
    ReportOptions.LastChange = 40354.744085636600000000
    ...
    Datasets = <
      item
        DataSet = tblRelBAE
        DataSetName = 'tblRelBAE'
      end
      item
        DataSet = tblRelBAEDados
        DataSetName = 'tblRelBAEDados'
      end
      item
    ...
    object Page1: TfrxReportPage
      ...
      object Band6: TfrxMasterData
        ...
        object Memo10: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[<tblRelBAEDados."CUSTO">*<tblRelBAEDados."QUANTIDADE">]')
          ParentFont = False
        end
      end
      ...
      object Header1: TfrxHeader
        ...
        object Memo9: TfrxMemoView
          ...
          GapX = 6.000000000000000000
          Memo.UTF8W = (
            '[(<tblRelBAE."EMPRESA">)]  -  [(<tblRelBAE."CIDADE">)]')
          ParentFont = False
          VAlign = vaCenter
        end
      end
  ...
  object tblRelBAEDados: TfrxDBDataset
    UserName = 'tblRelBAEDados'
  ...
  object tblRelBAE: TfrxDBDataset
    UserName = 'tblRelBAE'
    CloseDataSource = False
    FieldAliases.Strings = (
      'ID_BAE=ID_BAE'
  ...
  object IBQuery2: TIBQuery
    ...
    ParamCheck = True
    SQL.Strings = (
      'select sum(CUSTO*QUANTIDADE) as Valor from BAE_DADOS'
      ''
      'where id_BAE = :IdBAE')
    Left = 424
    Top = 216

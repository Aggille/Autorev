object BoxPecasFabrica: TBoxPecasFabrica
  Left = 5
  Top = 85
  Caption = 'Cadastro de Pe'#231'as da F'#225'brica'
  ClientHeight = 250
  ClientWidth = 596
  Color = clBtnFace
  ...
  object tblPecasFabrica: TIBDataSet
    ...
    AfterCancel = tblPecasFabricaAfterCancel
    AfterDelete = tblPecasFabricaAfterPost
    AfterPost = tblPecasFabricaAfterPost
    BufferChunks = 1000
    CachedUpdates = False
    DeleteSQL.Strings = (
      'delete from PECYAM'

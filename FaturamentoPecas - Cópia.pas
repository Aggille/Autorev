...
uses
  ...
  IBQuery, rxToolEdit, rxCurrEdit, DBCtrls, ButtonGroup;
...
var
  Gerar : Boolean;
begin
// if Fdb1.AtualizaDebitoCliente(tblPessoas.FieldByName('id_Clientes').AsInteger) then
//  if tblPessoas.FieldByName('SPC').AsString = 'T' then
//   showmessage('Cliente com débito, faturamento não autorizado.')
// else
 begin

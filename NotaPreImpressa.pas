...
type
  TBoxNotaPreImpressa = class (TForm)
    private
    public
      teste: String;
      procedure Imprime;
...
uses DataNota, efuncoes;


procedure TBoxNotaPreImpressa.Imprime;
var
ModoTexto: TPrnDOS;
       ...
       begin
        with tblNoFisa do
          begin
            ...
            cmpsay( 11 , 003 , tblPessoas.fieldbyname( 'nome' ).asString + ' - ' + fieldbyname( 'cliente' ).asString );

            cmpsay( 11 , 093 , tblPessoas.fieldbyname( 'cgc_cpf' ).DisplayText );
            cmpsay( 11 , 124 , fieldbyname( 'emissao' ).asString );

            cmpsay( 13 , 003 , tblPessoas.fieldbyname( 'endereco' ).asString );
            cmpsay( 13 , 058 , tblPessoas.fieldbyname( 'bairro' ).asString );
            cmpsay( 13 , 102 , tblPessoas.fieldbyname( 'cep' ).DisplayText );
            cmpsay( 13 , 124, fieldbyname( 'data_saida' ).asString );

            cmpsay( 15 , 003 , tblPessoas.fieldbyname( 'cidade' ).asString );
            cmpsay( 15 , 057 , tblPessoas.fieldbyname( 'telefone' ).asString );
            cmpsay( 15 , 082 , tblPessoas.fieldbyname( 'uf' ).asString );
            cmpsay( 15 , 089 , tblPessoas.fieldbyname( 'inscricaoestadual' ).asString );
...
//            obs.Text := tblNofisaOBSERVACOES.asString ;

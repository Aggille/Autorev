...
type
  TBoxComprasPecasXML = class(TForm)
    ...
    tblPecas2VBC_STRET: TIBBCDField;
    tblPecas2PST: TIBBCDField;
    tblPecas2VICMS_STRET: TIBBCDField;
    tblPecas2PMVAST: TIBBCDField;
    tblPecas2PRED_BCST: TIBBCDField;
    tblPecas2VBC_ST: TIBBCDField;
    tblPecas2PICMS_ST: TIBBCDField;
    tblPecas2VICMS_ST: TIBBCDField;

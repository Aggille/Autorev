object BoxDescontoFinanceira: TBoxDescontoFinanceira
  Left = 15
  Top = 85
  Caption = 'NF de desconto de financeira'
  ClientHeight = 115
  ClientWidth = 217
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object Label5: TLabel
      ...
      Width = 109
      Height = 13
      Caption = 'N'#186' da NF de desconto:'
    end
    ...
    object ValorDesconto: TCurrencyEdit
      Left = 122
      Top = 36
      Width = 87
      Height = 21
  ...
  object tblNofisa: TIBDataSet
    ...
    SelectSQL.Strings = (
      ...
      'Id_Concessionaria = :IdConcessionaria and'
      'SerieNF = :idSerieNF')
    ModifySQL.Strings = (
      'update Nofisa'
      'set'

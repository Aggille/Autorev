object BoxMalaDireta: TBoxMalaDireta
  Left = 15
  Top = 85
  Caption = 'Mala direta'
  ClientHeight = 119
  ...
  object tblRelClientes: TfrxDBDataset
    UserName = 'tblRelClientes'
  ...
  object tblClientes: TIBDataSet
    ...
    RefreshSQL.Strings = (
      ...
      '  ID_CLIENTES = :ID_CLIENTES')
    SelectSQL.Strings = (
      'select c.*, co.empresa, co.cidade'
      'from Clientes c'
      ''
      
        'inner join Concessionaria co on c.id_concessionaria = co.id_conc' +
        'essionaria'
      ''
      'where'
      'extract(month from c.nascimento) >= :MesInicial'
      'and'
      'extract(day from c.nascimento) >= :DiaInicial'
      'and'
      'extract(month from c.nascimento) <= :MesFinal'
      'and'
      'extract(day from c.nascimento) <= :DiaFinal'
      'order by '
      'extract(day from c.nascimento),'
      'extract(month from c.nascimento),'
      'extract(year from c.nascimento)')
    ModifySQL.Strings = (
      'update Clientes'
      'set'
      '  ADMISSAO = :ADMISSAO,'
    ...
    object tblClientesVENDEDOR_YNOVA: TIBStringField
    ...
    object tblClientesNOME_VENDEDOR: TIBStringField
      FieldName = 'NOME_VENDEDOR'
      Origin = '"CLIENTES"."NOME_VENDEDOR"'
    end
    object tblClientesCODIGOSGS: TIntegerField
      FieldName = 'CODIGOSGS'
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.Description.Strings = (
        ...
        '.')
    ReportOptions.LastChange = 40361.439074467590000000
    ...
    Datasets = <
      item
        DataSet = tblRelClientes
        DataSetName = 'tblRelClientes'
      end>
    Variables = <>
    Style = <>
    ...
    object Page1: TfrxReportPage
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object Memo22: TfrxMemoView
          ...
          HAlign = haCenter
          Memo.UTF8 = (
            'Relat'#195#179'rio de mala direta:')
          ParentFont = False
        end

object BoxRelatoriosIndividualComissoes: TBoxRelatoriosIndividualComissoes
  Left = 0
  Top = 0
  Caption = 'Relat'#243'rio individual de comiss'#245'es'
  ClientHeight = 444
  ClientWidth = 882
  Color = clBtnFace
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 42989.676069062500000000
    ...
    ScriptText.Strings = (
      ...
      'begin                                          '
        ...
        '//  if <tblRelPedidoVeiculos."VALOR_DA_VENDA".AsCurrency> > < tb' +
        'lPedidoVeiculos.FieldByName('#39'Valor_Exclusivo'#39').AsCurrency> then ' +
        '                                                      '
      '  percentual := 0.8;'
      
        '  if <tblRelPedidoVeiculos."VALOR_DA_VENDA"> >= <tblRelPedidoVei' +
        'culos."VALOR_NORMAL"> then        '
      '  //<[ValorNormal]> then'
      '    percentual := 1.0;'
      
        '  if <tblRelPedidoVeiculos."VALOR_DA_VENDA"> >= <tblRelPedidoVei' +
        'culos."VALOR_VIP"> then'
      '    percentual := 1.2;      '
      'end;'
      ''
      ...
      'begin'
        ...
        '  comissao := (percentual * <tblRelPedidoVeiculos."BASE_COMISSAO' +
        '">)/100;                                                        ' +
        '                                                                ' +
        '           '
      'end;'
  ...
  object tblComissoes: TIBDataSet
    ...
    BeforeCancel = tblComissoesAfterCancel
    BufferChunks = 1000
    CachedUpdates = True
    DeleteSQL.Strings = (
    ...
    InsertSQL.Strings = (
      'insert into Comissoes'
        ...
        'ABELA_NORMAL, '
      '   TABELA_EXCLUSIVA, PERCENTUAL, VALOR_COMISSAO, PERIODO)'
      'values'

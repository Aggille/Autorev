...
uses IniFiles,
  ...
  Dialogs, StdCtrls, ExtCtrls, Buttons, ComCtrls, OleCtrls, SHDocVw,pcnConversaoNFe,
  ACBrNFe, pcnConversao, ACBrNFeDANFEClass, pcnNFeW, ACBrBase, ACBrDFe;
...
begin
  ...
  try
      ...
      Ini.WriteString( 'Emitente','CNAE'       ,edtEmitCNAE.Text) ;
...
procedure TBoxNFeConfiguracoes.LoadXML(MyMemo: TMemo; MyWebBrowser: TWebBrowser);
begin
...
procedure TBoxNFeConfiguracoes.sbtnLogoMarcaClick(Sender: TObject);
begin
...
procedure TBoxNFeConfiguracoes.sbtnPathSalvarClick(Sender: TObject);
var
  Dir: string;
begin
...
procedure TBoxNFeConfiguracoes.FormCreate(Sender: TObject);
begin
 LerConfiguracao;
end;
...
procedure TBoxNFeConfiguracoes.btnStatusServClick(Sender: TObject);
begin
...
procedure TBoxNFeConfiguracoes.btnConsultarClick(Sender: TObject);
begin
...
procedure TBoxNFeConfiguracoes.btnCancNFClick(Sender: TObject);
var
  vAux : String;
begin
  OpenDialog1.Title := 'Selecione a NFE';
...
procedure TBoxNFeConfiguracoes.btnValidarXMLClick(Sender: TObject);
begin
  OpenDialog1.Title := 'Selecione a NFE';
  OpenDialog1.DefaultExt := '*-nfe.XML';
  OpenDialog1.Filter := 'Arquivos NFE (*-nfe.XML)|*-nfe.XML|Arquivos XML (*.XML)|*.XML|Todos os Arquivos (*.*)|*.*';
...
procedure TBoxNFeConfiguracoes.btnImprimirClick(Sender: TObject);
begin
  OpenDialog1.Title := 'Selecione a NFE';
  OpenDialog1.DefaultExt := '*-nfe.XML';
  OpenDialog1.Filter := 'Arquivos NFE (*-nfe.XML)|*-nfe.XML|Arquivos XML (*.XML)|*.XML|Todos os Arquivos (*.*)|*.*';
...
procedure TBoxNFeConfiguracoes.btnCriarEnviarClick(Sender: TObject);
var
 vAux : String;
begin
...
procedure TBoxNFeConfiguracoes.btnInutilizarClick(Sender: TObject);
var
...
procedure TBoxNFeConfiguracoes.ACBrNFe1StatusChange(Sender: TObject);
begin
...
procedure TBoxNFeConfiguracoes.sbtnGetCertClick(Sender: TObject);
begin
...
procedure TBoxNFeConfiguracoes.btnGerarNFEClick(Sender: TObject);
var
 vAux : String;
 LocNFeW : TNFeW;
begin

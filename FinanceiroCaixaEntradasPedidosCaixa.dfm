object BoxFinanceiroCaixaEntradasPedidosCaixa: TBoxFinanceiroCaixaEntradasPedidosCaixa
  Left = 15
  Top = 280
  Caption = 'Entradas de caixa - Pend'#234'ncias de pedidos - Recebimento no caixa'
  ClientHeight = 387
  ClientWidth = 578
  Color = clBtnFace

object BoxComprasPecas: TBoxComprasPecas
  Left = 15
  Top = 145
  Caption = 'Compras de pe'#231'as'
  ClientHeight = 385
  ClientWidth = 719
  Color = clBtnFace
  ...
  object PageControl: TPageControl
    ...
    object PageFaturas: TTabSheet
      ...
      object ValorFatura: TJvDBMaskEdit
        Left = 112
        Top = 69
        Width = 121
        Height = 21
        DataField = 'VALOR'
        DataSource = DataSourceNofiFaturas
        TabOrder = 1
        EditMask = ''
        OnKeyPress = FormKeyPress
      end
      object VencimentoFatura: TJvDBDateEdit
        Left = 112
        Top = 96
        Width = 121
        Height = 21
    ...
    object PagePecas: TTabSheet
      ...
      object IPIUnitario: TDBEdit
        ...
        DataSource = DataSourceNfda
        TabOrder = 7
        OnExit = IPIUnitarioExit
        OnKeyPress = FormKeyPress
      end
      object CreditoICMSUnitario: TDBEdit
        Left = 462
        Top = 57
        Width = 84
        Height = 21
      ...
      object ICMSSubstUnitario: TDBEdit
        Left = 622
        Top = 57
        Width = 84
        Height = 21
      ...
      object DBGrid1: TDBGrid
        ...
        Columns = <
          ...
          item
            ...
            Title.Alignment = taCenter
            Title.Caption = 'Valor ICMS Subst. R$:'
            Visible = True
          end
          item
            Expanded = False
  ...
  object ImageList1: TImageList
    Left = 384
    Bitmap = {
      494C01010B000C00140010001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  object tblPessoas: TIBDataSet
    ...
    InsertSQL.Strings = (
      'insert into CLIENTES'
        ...
        '   EMPRESA, ENDERECO, ESTADO, FABRICANTE, FINANCEIRA, FONE1, FON' +
        'E2, FONE3, '
      
        '   FORNECEDOR, FOTO, ID_CLIENTES, ID_CONCESSIONARIA, IDENTIDADE,' +
        ' MAE, MECANICO, '
      
        '   NASCIMENTO, NOME, NUM_CPF, PAI, REF_AG_BANC, REF_BANC, REF_CO' +
        'ML_FONE1, '
      ...
      'values'
        ...
        '   :EMPR_ESTADO, :EMPR_FONE, :EMPRESA, :ENDERECO, :ESTADO, :FABR' +
        'ICANTE, '
      
        '   :FINANCEIRA, :FONE1, :FONE2, :FONE3, :FORNECEDOR, :FOTO, :ID_' +
        'CLIENTES, '
      
        '   :ID_CONCESSIONARIA, :IDENTIDADE, :MAE, :MECANICO, :NASCIMENTO' +
        ', :NOME, '
      
        '   :NUM_CPF, :PAI, :REF_AG_BANC, :REF_BANC, :REF_COML_FONE1, :RE' +
        'F_COML_FONE2, '
  ...
  object tblNofi2: TIBDataSet
    ...
    SelectSQL.Strings = (
      'select * from NOFI'
      'where id_conhecimento = :idConhecimento')
    ModifySQL.Strings = (
      'update NOFI'
      'set'
      '  ARQUIVO = :ARQUIVO,'
    ...
    Left = 600
    Top = 200
    object tblNofi2ID_NOFI: TIntegerField
      FieldName = 'ID_NOFI'
      Origin = '"NOFI"."ID_NOFI"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
    end
    ...
    object tblNofi2ID_CONHECIMENTO: TIntegerField
      FieldName = 'ID_CONHECIMENTO'
      Origin = '"NOFI"."ID_CONHECIMENTO"'
    end
    object tblNofi2NUMERO: TIBStringField
      FieldName = 'NUMERO'
      Origin = '"NOFI"."NUMERO"'
      FixedChar = True
      Size = 8
    end
    object tblNofi2SERIE: TIBStringField
      FieldName = 'SERIE'
      Origin = '"NOFI"."SERIE"'
      FixedChar = True
      Size = 2
    ...
    object tblNofi2CODIGO: TIBStringField
      FieldName = 'CODIGO'
      Origin = '"NOFI"."CODIGO"'
      FixedChar = True
      Size = 5
    ...
    object tblNofi2VENDEDOR: TIBStringField
      FieldName = 'VENDEDOR'
      Origin = '"NOFI"."VENDEDOR"'
      FixedChar = True
      Size = 3
    end
    object tblNofi2COMISSAO: TIBBCDField
      FieldName = 'COMISSAO'
      Origin = '"NOFI"."COMISSAO"'
      Precision = 18
      Size = 2
    ...
    object tblNofi2CFOP: TIBStringField
      FieldName = 'CFOP'
      Origin = '"NOFI"."CFOP"'
      FixedChar = True
      Size = 14
    end
    object tblNofi2NAT_OP: TIBStringField
      FieldName = 'NAT_OP'
      Origin = '"NOFI"."NAT_OP"'
      FixedChar = True
      Size = 40
    ...
    object tblNofi2ICMS: TIBBCDField
      FieldName = 'ICMS'
      Origin = '"NOFI"."ICMS"'
      Precision = 9
      Size = 2
    ...
    object tblNofi2VAL_PIS: TIBBCDField
      FieldName = 'VAL_PIS'
      Origin = '"NOFI"."VAL_PIS"'
      Precision = 18
      Size = 2
    end
    object tblNofi2VAL_COFINS: TIBBCDField
      FieldName = 'VAL_COFINS'
      Origin = '"NOFI"."VAL_COFINS"'
      Precision = 18
      Size = 2
    ...
    object tblNofi2PROTOCOLO_CONSULTA: TIBStringField
      FieldName = 'PROTOCOLO_CONSULTA'
      Origin = '"NOFI"."PROTOCOLO_CONSULTA"'
      Size = 60
    end
    object tblNofi2BASE_ICMS: TFMTBCDField
      FieldName = 'BASE_ICMS'
      Origin = '"NOFI"."BASE_ICMS"'
      Precision = 18
      Size = 10
    end
    object tblNofi2VAL_ICMS: TFMTBCDField
      FieldName = 'VAL_ICMS'
      Origin = '"NOFI"."VAL_ICMS"'
      Precision = 18
      Size = 10
  ...
  object tblPecas: TIBDataSet
    ...
    object tblPecasCST2: TIBStringField
      FieldName = 'CST'
      Origin = '"PECAS"."CST"'
      Size = 3
    end
  ...
  object IBQuery2: TIBQuery
    ...
    ParamCheck = True
    SQL.Strings = (
      'SELECT GEN_ID(Seq_Conhecimento_Id, 1) as'
      'Id_Conhecimento From RDB$DATABASE')
    Left = 640
    Top = 88
  end
  object IBQueryICMS: TIBQuery
    Database = FDB1.IBDatabase
    Transaction = FDB1.IBTransaction
    AfterCancel = tblConhecimentoAfterCancel
    AfterDelete = tblConhecimentoAfterPost
    ...
    ParamCheck = True
    SQL.Strings = (
      'select sum(Dados_NFe.vlr_icms) as Valor'
      'from Dados_NFE'
      'where Dados_NFE.Id_Nofi = :idNofi')
    Left = 408
    Top = 184
    ParamData = <
      item
  ...
  object IBQueryIPI: TIBQuery
    ...
    ParamCheck = True
    SQL.Strings = (
      'select sum(Dados_NFe.vlr_ipi) as Valor'
      'from Dados_NFE'
      'where Dados_NFE.Id_Nofi = :idNofi')
    Left = 464
    Top = 184
  ...
  object IBQueryICMSSubst: TIBQuery
    Database = FDB1.IBDatabase
    Transaction = FDB1.IBTransaction
    AfterCancel = tblConhecimentoAfterCancel
    AfterDelete = tblConhecimentoAfterPost
    ...
    ParamCheck = True
    SQL.Strings = (
      'select sum(Dados_NFe.icms_Subst) as Valor'
      'from Dados_NFE'
      'where Dados_NFE.Id_Nofi = :idNofi')
    Left = 496
    Top = 184
  ...
  object IBQueryTotal: TIBQuery
    ...
    ParamCheck = True
    SQL.Strings = (
      'select sum(Dados_NFe.vlr_unit*Dados_NFe.Qtde) as Valor'
      'from Dados_NFE'
      'where Dados_NFE.Id_Nofi = :idNofi')
    Left = 432
    Top = 240
  ...
  object tblNofiFaturas: TIBDataSet
    Database = FDB1.IBDatabase
    Transaction = FDB1.IBTransaction
    AfterCancel = tblConhecimentoAfterCancel
    AfterDelete = tblConhecimentoAfterPost
    AfterInsert = tblNofiFaturasAfterInsert
    AfterPost = tblConhecimentoAfterPost
    BeforePost = tblNofiFaturasBeforePost
    BufferChunks = 1000
    CachedUpdates = False
    DeleteSQL.Strings = (
      'delete from NOFI_FATURAS'
      'where'
      '  ID_NOFI = :OLD_ID_NOFI')
    InsertSQL.Strings = (
      'insert into NOFI_FATURAS'
      '  (FATURA, ID_NOFI, ID_NOFI_FATURAS, VALOR, VENCIMENTO)'
      'values'
      '  (:FATURA, :ID_NOFI, :ID_NOFI_FATURAS, :VALOR, :VENCIMENTO)')
    RefreshSQL.Strings = (
      'Select '
    ...
    ModifySQL.Strings = (
      ...
      '  FATURA = :FATURA,'
      '  ID_NOFI = :ID_NOFI,'
      '  ID_NOFI_FATURAS = :ID_NOFI_FATURAS,'
      '  VALOR = :VALOR,'
    ...
    Left = 512
    Top = 64
    object tblNofiFaturasID_NOFI_FATURAS: TIntegerField
      FieldName = 'ID_NOFI_FATURAS'
      Origin = '"NOFI_FATURAS"."ID_NOFI_FATURAS"'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
    end
    object tblNofiFaturasID_NOFI: TIntegerField
      FieldName = 'ID_NOFI'
      Origin = '"NOFI_FATURAS"."ID_NOFI"'
      Required = True
    end
    object tblNofiFaturasFATURA: TIBStringField
      FieldName = 'FATURA'
      Origin = '"NOFI_FATURAS"."FATURA"'
      Size = 10
    end
    object tblNofiFaturasVENCIMENTO: TDateField
      FieldName = 'VENCIMENTO'
      Origin = '"NOFI_FATURAS"."VENCIMENTO"'
    end
    object tblNofiFaturasVALOR: TIBBCDField
      FieldName = 'VALOR'
      Origin = '"NOFI_FATURAS"."VALOR"'
      currency = True
      Precision = 18
      Size = 2
    end
  end
  object DataSourceNofiFaturas: TDataSource
    AutoEdit = False
    DataSet = tblNofiFaturas
    Left = 512
    Top = 96
  end
  object IBQueryNofiFaturas: TIBQuery
    Database = FDB1.IBDatabase
    Transaction = FDB1.IBTransaction
    AfterCancel = tblConhecimentoAfterCancel
    AfterDelete = tblConhecimentoAfterPost
    ...
    ParamCheck = True
    SQL.Strings = (
      'select sum(Nofi_Faturas.valor) as Valor'
      'from Nofi_Faturas'
      'where Nofi_Faturas.Id_Nofi = :idNofi')
    Left = 480
    Top = 96
    ParamData = <
      item

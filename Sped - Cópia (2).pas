...
type
  TBoxSped = class(TForm)
    ...
    qryNf1ID_NOFISA: TIntegerField;
    qryNf1ID_CONCESSIONARIA: TIntegerField;
    qryNf1ID_CLIENTES: TIntegerField;
    qryNf1NUMERO: TIntegerField;
    qryNf1SERIENF: TIBStringField;
    qryNf1EMISSAO: TDateField;
    qryNf1ORIGEM: TIBStringField;
    qryNf1ENT_SAI: TIBStringField;
    qryNf1VENDEDOR: TIntegerField;
    qryNf1SAIDA: TDateField;
    qryNf1HORA: TIBStringField;
    qryNf1IE_SUBS: TIBStringField;
    qryNf1DESC_PEC: TIBBCDField;
    qryNf1DESC_OFI: TIBBCDField;
    qryNf1BASE_ICMS: TIBBCDField;
    qryNf1VAL_ICMS: TIBBCDField;
    qryNf1BASE_ICM_S: TIBBCDField;
    qryNf1VAL_ICMS_S: TIBBCDField;
    qryNf1VAL_FRETE: TIBBCDField;
    qryNf1VAL_SEGURO: TIBBCDField;
    qryNf1VAL_OUTROS: TIBBCDField;
    qryNf1VAL_IPI: TIBBCDField;
    qryNf1VAL_SERV: TIBBCDField;
    qryNf1ISSQN: TIBBCDField;
    qryNf1VAL_ISS: TIBBCDField;
    qryNf1TOT_PROD: TIBBCDField;
    qryNf1TOT_NOTA: TIBBCDField;
    qryNf1PIS: TIBBCDField;
    qryNf1COFINS: TIBBCDField;
    qryNf1COD_TRANS: TIBStringField;
    qryNf1FRETE_TIPO: TIBStringField;
    qryNf1PLACA: TIBStringField;
    qryNf1DADOS_AD01: TIBStringField;
    qryNf1DADOS_AD02: TIBStringField;
    qryNf1DADOS_AD03: TIBStringField;
    qryNf1DADOS_AD04: TIBStringField;
    qryNf1OBS: TIBStringField;
    qryNf1QTDE_PROD: TIntegerField;
    qryNf1STATUS: TIBStringField;
    qryNf1CODIGO_FISCAL: TIBStringField;
    qryNf1DESCRICAO_CODIGO_FISCAL: TIBStringField;
    qryNf1FORMA_PAGAMENTO: TIBStringField;
    qryNf1CHAVE: TIBStringField;
    qryNf1RECIBO: TIBStringField;
    qryNf1PROTOCOLO: TIBStringField;
    qryNf1ARQUIVO: TIBStringField;
    qryNf1XML: TBlobField;
    ...
    qryItemNf1: TIBDataSet;
    qryItemNf1ID_SADA: TIntegerField;
    qryItemNf1ID_NOFISA: TIntegerField;
    qryItemNf1ID_CONCESSIONARIA: TIntegerField;
    qryItemNf1NF: TIBStringField;
    qryItemNf1CODIGO: TIBStringField;
    qryItemNf1DESCRICAO: TIBStringField;
    qryItemNf1QTDE: TSmallintField;
    qryItemNf1UNIDADE: TIBStringField;
    qryItemNf1CST: TIBStringField;
    qryItemNf1SUBST: TIBStringField;
    qryItemNf1ALIQ_ICMS: TIBBCDField;
    qryItemNf1ICMS: TIBBCDField;
    qryItemNf1CUSTO: TIBBCDField;
    qryItemNf1PRECO: TIBBCDField;
    qryItemNf1CFOP: TIBStringField;
    qryItemNf1NAT_OP: TIBStringField;
    qryItemNf1ST_COFINS: TIBStringField;
    qryItemNf1ANO_MODELO: TIBStringField;
    qryItemNf1ANO_FABRICACAO: TIBStringField;
    qryItemNf1RENAVAM: TIBStringField;
    qryItemNf1POTENCIA: TIBStringField;
    qryItemNf1COR: TIBStringField;
    qryItemNf1COMBUSTIVEL: TIBStringField;
    qryItemNf1PLACA: TIBStringField;
    qryItemNf1MOTOR: TIBStringField;
    qryItemNf1CHASSI: TIBStringField;
    qryItemNf1MARCA: TIBStringField;
    qryItemNf1MODELO: TIBStringField;
    qryItemNf1STATUS: TIBStringField;
    qryDupl: TIBDataSet;
    dtsDupl: TDataSource;
    ...
    qryItemNf1BASE_ICMS: TIBBCDField;
    qryItemNf1DESCONTO: TIBBCDField;
    qryItemNf1ID_PECAS: TIntegerField;
    qryItemNf1NCM: TIBStringField;
    qryItemNf1CILINDRADAS: TIntegerField;
    qryItemNf1COD_PROC: TIBStringField;
    qryItemNf1ST_COFINS1: TIBStringField;
    qryItemNf1SUBST_TRIB: TIBStringField;

object BoxFaturamentoGarantia: TBoxFaturamentoGarantia
  Left = 15
  Top = 150
  Caption = 'Faturamento garantia'
  ClientHeight = 473
  ClientWidth = 703
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object CodigoFabricante: TMaskEdit
      Left = 89
      Top = 66
      Width = 41
      Height = 21
      ...
      TabOrder = 3
      Text = ''
      OnExit = CodigoFabricanteExit
      OnKeyPress = FormKeyPress
    end
    object NomeFabricante: TJvDBMaskEdit
      Left = 269
      Top = 66
      Width = 372
      Height = 21
  ...
  object tblNofisa: TIBDataSet
    ...
    InsertSQL.Strings = (
      'insert into Nofisa'
        ...
        ', VAL_SEGURO, '
      '   VAL_SERV, VENDEDOR, XML,QUANTIDADE_VOLUMES)'
      'values'
  ...
  object tblAtendimentoPecas: TIBDataSet
    ...
    SelectSQL.Strings = (
      'select a.ID_ATENDIMENTO, a.ID_ATENDIMENTO_PECAS, '
      'a.ID_CONCESSIONARIA, a.ID_PECAS, a.PRECO,'
      'a.PRECO_TABELA, a.QUANTIDADE, a.STATUS,'
      'p.codigo'
      ''
      'from ATENDIMENTO_PECAS a'
      'inner join pecas p on a.id_pecas = p.id_pecas'
      'where id_Atendimento = :idAtendimento')
    ModifySQL.Strings = (
